...
| [**getDatasetsV12()**](DatasetsApi.md#getDatasetsV12) | **GET** /api/v1_2/datasets | Get Datasets v1.2 |
...
```php
getDatasetsV12(): \BhrSdk\Model\DatasetsResponse
```
...
try {
    $result = $apiInstance->getDatasetsV12();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DatasetsApi->getDatasetsV12: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\BhrSdk\Model\DatasetsResponse**](../Model/DatasetsResponse.md)
...
```php
getFieldOptionsV12($dataset_name, $field_options_request_schema): \BhrSdk\Model\FieldOptionsTransformer[]
```
