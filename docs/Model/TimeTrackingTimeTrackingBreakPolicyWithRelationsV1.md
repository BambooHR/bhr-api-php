...
------------ | ------------- | ------------- | -------------
**id** | **string** | Unique identifier for the break policy | [optional] [readonly]
...
**breaks** | [**\BhrSdk\Model\TimeTrackingTimeTrackingBreakV1[]**](TimeTrackingTimeTrackingBreakV1.md) | The breaks that are assigned to this policy | [optional]
**employee_ids** | **int[]** | The employees that are assigned to this policy | [optional]
