...
**cycle_currency** | **string** |  | [optional]
...
**cycle_currency_conversion_rates** | [**\BhrSdk\Model\ConversionRateDataObject[]**](ConversionRateDataObject.md) | Currency conversion rates | [optional]
