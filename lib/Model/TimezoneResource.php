...
/**
 * TimezoneResource Class Doc Comment
 *
 * @category Class
 ...
 */
class TimezoneResource implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimezoneResource';
	...
	public function __construct(?array $data = null) {
		...
		$this->setIfExists('utc_name', $data ?? [], null);
	}
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id The timezone ID.
	 *
	 * @return self
	 */
	 ...
	 * Sets gmt_offset
	 *
	 * @param string|null $gmt_offset The GMT offset label (e.g. \"(GMT-07:00)\").
	 *
	 * @return self
	 */
	 ...
	 * Sets name
	 *
	 * @param string|null $name The display name of the timezone.
	 *
	 * @return self
	 */
	...
	public function getUtcName() {
		return $this->container['utc_name'];
	}

	/**
	 * Sets utc_name
	 *
	 * @param string|null $utc_name The IANA/UTC timezone identifier.
	 *
	 * @return self
	 */
	public function setUtcName($utc_name) {
		if (is_null($utc_name)) {
			throw new \InvalidArgumentException('non-nullable utc_name cannot be null');
		}
		$this->container['utc_name'] = $utc_name;
