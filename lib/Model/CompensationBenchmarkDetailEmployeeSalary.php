...
/**
 * CompensationBenchmarkDetailEmployeeSalary Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationBenchmarkDetailEmployeeSalary implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationBenchmarkDetailEmployee_salary';
