...
/**
 * ProjectPaginatedTasksResponseV1Meta Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ProjectPaginatedTasksResponseV1Meta implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Project_PaginatedTasksResponse_V1_meta';
	...
	*/
	...
	public function setTotalItems($total_items) {
		...
		if (($total_items < 0)) {
			throw new \InvalidArgumentException('invalid value for $total_items when calling ProjectPaginatedTasksResponseV1Meta., must be bigger than or equal to 0.');
		}
	...
	public function setPage($page) {
		...
		if (($page < 1)) {
			throw new \InvalidArgumentException('invalid value for $page when calling ProjectPaginatedTasksResponseV1Meta., must be bigger than or equal to 1.');
		}
	...
	public function setPageSize($page_size) {
		...
		if (($page_size < 1)) {
			throw new \InvalidArgumentException('invalid value for $page_size when calling ProjectPaginatedTasksResponseV1Meta., must be bigger than or equal to 1.');
		}
	...
	public function setTotalPages($total_pages) {
		...
		if (($total_pages < 0)) {
			throw new \InvalidArgumentException('invalid value for $total_pages when calling ProjectPaginatedTasksResponseV1Meta., must be bigger than or equal to 0.');
		}
