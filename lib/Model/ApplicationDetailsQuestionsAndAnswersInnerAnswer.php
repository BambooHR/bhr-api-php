...
/**
 * ApplicationDetailsQuestionsAndAnswersInnerAnswer Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationDetailsQuestionsAndAnswersInnerAnswer implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ApplicationDetails_questionsAndAnswers_inner_answer';
