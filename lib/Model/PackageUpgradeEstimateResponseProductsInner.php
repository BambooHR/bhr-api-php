<?php
/**
 * PackageUpgradeEstimateResponseProductsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PackageUpgradeEstimateResponseProductsInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PackageUpgradeEstimateResponseProductsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageUpgradeEstimateResponse_products_inner';
    ...
    */
     ...
     * Sets price
     *
     * @param float|null $price Price per employee
     *
     * @return self
     */
