...
/**
 * ChangedEmployeeTableDataResponseEmployeesValueRowsInnerValue Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ChangedEmployeeTableDataResponseEmployeesValueRowsInnerValue implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ChangedEmployeeTableDataResponse_employees_value_rows_inner_value';
