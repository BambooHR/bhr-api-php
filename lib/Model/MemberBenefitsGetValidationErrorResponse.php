...
/**
 * MemberBenefitsGetValidationErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class MemberBenefitsGetValidationErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'MemberBenefitsGetValidationErrorResponse';
