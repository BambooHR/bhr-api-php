...
/**
 * AlertTemplateListResponseAlertsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class AlertTemplateListResponseAlertsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'AlertTemplateListResponse_alerts_inner';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id Alert template ID (bambooAlertId)
	 *
	 * @return self
	 */
	 ...
	 * Sets name
	 *
	 * @param string|null $name Display name of the alert
	 *
	 * @return self
	 */
	 ...
	 * Sets group_name
	 *
	 * @param string|null $group_name Category group the alert belongs to
	 *
	 * @return self
	 */
