...
/**
 * ListValueSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ListValueSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListValueSchema';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('adp_code', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getAdpCode()
    {
        return $this->container['adp_code'];
    }
     ...
     * @return self
     */
    public function setAdpCode($adp_code)
    {
        if (is_null($adp_code)) {
            throw new \InvalidArgumentException('non-nullable adp_code cannot be null');
        }
        $this->container['adp_code'] = $adp_code;
     ...
     * Sets archived_ymdt
     *
     * @param string|null $archived_ymdt archived_ymdt
     *
     * @return self
     */
    public function setArchivedYmdt($archived_ymdt)
    {
        if (is_null($archived_ymdt)) {
            throw new \InvalidArgumentException('non-nullable archived_ymdt cannot be null');
        }
