...
/**
 * DirectoryEmployeeEmployeesEmployeeInnerFieldInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class DirectoryEmployeeEmployeesEmployeeInnerFieldInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'DirectoryEmployee_employees_employee_inner_field_inner';
