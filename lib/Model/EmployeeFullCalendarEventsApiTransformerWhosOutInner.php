<?php
/**
 * EmployeeFullCalendarEventsApiTransformerWhosOutInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * EmployeeFullCalendarEventsApiTransformerWhosOutInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeFullCalendarEventsApiTransformerWhosOutInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeFullCalendarEventsApiTransformer_whosOut_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Time off request ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $time_off_type_id Time off type ID
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param string|null $start Start date of time off
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end End date of time off
     *
     * @return self
     */
