...
/**
 * RemoveTotalRewardsEmployeesRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class RemoveTotalRewardsEmployeesRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'remove_total_rewards_employees_request';
	...
	*/
	 ...
	 * Sets employee_ids
	 *
	 * @param int[] $employee_ids List of employee IDs to remove from Total Rewards.
	 *
	 * @return self
	 */
