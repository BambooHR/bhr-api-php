...
/**
 * UpdateEmployeeVerificationIntegrationRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEmployeeVerificationIntegrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_employee_verification_integration_request';
	...
	*/
	 ...
	 * Sets enabled
	 *
	 * @param bool $enabled Desired enabled state for the integration.
	 *
	 * @return self
	 */
