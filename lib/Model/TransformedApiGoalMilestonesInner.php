...
/**
 * TransformedApiGoalMilestonesInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class TransformedApiGoalMilestonesInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TransformedApiGoal_milestones_inner';
	...
	protected static $setters = [
		...
		'last_update_date_time' => 'setLastUpdateDateTime',
	...
	protected static $getters = [
		...
		'last_update_date_time' => 'getLastUpdateDateTime',
	...
	public function __construct(?array $data = null) {
		...
		$this->setIfExists('last_update_date_time', $data ?? [], null);
	...
	*/
	 ...
	 * Sets current_value
	 *
	 * @param float|null $current_value current_value
	 *
	 * @return self
	 */
	 ...
	 * Sets start_value
	 *
	 * @param float|null $start_value start_value
	 *
	 * @return self
	 */
	 ...
	 * Sets end_value
	 *
	 * @param float|null $end_value end_value
	 *
	 * @return self
	 */
	...
	public function getLastUpdateDateTime() {
		return $this->container['last_update_date_time'];
	}

	/**
	 * Sets last_update_date_time
	 *
	 * @param string|null $last_update_date_time The date and time in which the goal was last updated.
	 *
	 * @return self
	 */
	public function setLastUpdateDateTime($last_update_date_time) {
		if (is_null($last_update_date_time)) {
			throw new \InvalidArgumentException('non-nullable last_update_date_time cannot be null');
		}
		$this->container['last_update_date_time'] = $last_update_date_time;
