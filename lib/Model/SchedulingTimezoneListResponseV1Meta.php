...
/**
 * SchedulingTimezoneListResponseV1Meta Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SchedulingTimezoneListResponseV1Meta implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Scheduling_TimezoneListResponse_V1_meta';
	...
	*/
	 ...
	 * Sets total_items
	 *
	 * @param int|null $total_items Total number of timezones matching the filter.
	 *
	 * @return self
	 */
