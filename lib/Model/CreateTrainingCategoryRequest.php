...
/**
 * CreateTrainingCategoryRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateTrainingCategoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_training_category_request';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string $name Name of the new training category.
	 *
	 * @return self
	 */
