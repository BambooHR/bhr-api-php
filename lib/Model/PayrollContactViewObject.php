...
/**
 * PayrollContactViewObject Class Doc Comment
 *
 * @category Class
 ...
 */
class PayrollContactViewObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayrollContactViewObject';
    ...
    */
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name Full name of the payroll contact
     *
     * @return self
     */
     ...
     * Sets work_email
     *
     * @param string|null $work_email Work email address of the payroll contact
     *
     * @return self
     */
     ...
     * Sets work_phone
     *
     * @param string|null $work_phone Work phone number of the payroll contact
     *
     * @return self
     */
     ...
     * Sets work_extension
     *
     * @param string|null $work_extension Work phone extension of the payroll contact
     *
     * @return self
     */
    public function setWorkExtension($work_extension)
    {
        if (is_null($work_extension)) {
            array_push($this->openAPINullablesSetToNull, 'work_extension');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('work_extension', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Whether the payroll contact is active
     *
     * @return self
     */
