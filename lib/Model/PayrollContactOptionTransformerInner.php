<?php
/**
 * PayrollContactOptionTransformerInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PayrollContactOptionTransformerInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayrollContactOptionTransformerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayrollContactOptionTransformer_inner';
    ...
    */
     ...
     * Sets user_id
     *
     * @param int|null $user_id User ID of the contact
     *
     * @return self
     */
     ...
     * Sets work_email
     *
     * @param string|null $work_email Work email of the contact
     *
     * @return self
     */
     ...
     *
     * @param string|null $work_phone_number Work phone number of the contact
     *
     * @return self
     */
    public function setWorkPhoneNumber($work_phone_number)
    {
        if (is_null($work_phone_number)) {
            array_push($this->openAPINullablesSetToNull, 'work_phone_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('work_phone_number', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $work_phone_extension Work phone extension of the contact
     *
     * @return self
     */
     ...
     * Sets photo_url
     *
     * @param string|null $photo_url URL to the contact's photo
     *
     * @return self
     */
