...
/**
 * TimeOffRequest1Status Class Doc Comment
 *
 * @category Class
 ...
 */
class TimeOffRequest1Status implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeOffRequest_1_status';
	...
	*/
	 ...
	 * Sets last_changed
	 *
	 * @param \DateTime|null $last_changed The date the status was last changed (company timezone).
	 *
	 * @return self
	 */
