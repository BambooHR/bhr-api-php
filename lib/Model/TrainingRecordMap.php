...
/**
 * TrainingRecordMap Class Doc Comment
 *
 * @category Class
 ...
 */
class TrainingRecordMap implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TrainingRecordMap';
