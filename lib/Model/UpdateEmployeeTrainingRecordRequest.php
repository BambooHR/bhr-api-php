 ...
 */
class UpdateEmployeeTrainingRecordRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_employee_training_record_request';
	...
	*/
	 ...
	 * Sets completed
	 *
	 * @param string $completed Completed is the only required field and must be in yyyy-mm-dd format. The other parameters are optional.
	 *
	 * @return self
	 */
