...
/**
 * BenefitDeductionTypeId Class Doc Comment
 *
 * @category Class
 * @description The deduction type ID. Integer for leaf types (e.g. 1 for 401(k)); string slug for grouped parent types (e.g. \&quot;pretax_subtype\&quot;).
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BenefitDeductionTypeId implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'BenefitDeductionType_id';
