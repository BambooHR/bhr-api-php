...
/**
 * LoginXmlResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class LoginXmlResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LoginXmlResponse';
	...
	*/
	 ...
	 * Sets response
	 *
	 * @param string|null $response Always `authenticated` on HTTP 200.
	 *
	 * @return self
	 */
	 ...
	 * Sets employee_id
	 *
	 * @param int|null $employee_id The employee ID linked to this user. Rendered as `<employeeId isNull=\"yes\"/>` when no employee record is associated.
	 *
	 * @return self
	 */
	 ...
	 * Sets key
	 *
	 * @param string|null $key The API key to use for subsequent requests.
	 *
	 * @return self
	 */
	 ...
	 * Sets api_url
	 *
	 * @param string|null $api_url The base URL for subsequent API calls.
	 *
	 * @return self
	 */
