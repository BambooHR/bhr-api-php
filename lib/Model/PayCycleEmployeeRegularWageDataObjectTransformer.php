...
/**
 * PayCycleEmployeeRegularWageDataObjectTransformer Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayCycleEmployeeRegularWageDataObjectTransformer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayCycleEmployeeRegularWageDataObjectTransformer';
    ...
    */
     ...
     * Sets rate
     *
     * @param float|null $rate transform
     *
     * @return self
     */
     ...
     * Sets rate_original
     *
     * @param float|null $rate_original rate_original
     *
     * @return self
     */
