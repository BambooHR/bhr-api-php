...
/**
 * TimeTrackingBreakPolicyEmployeeCollectionV1Inner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class TimeTrackingBreakPolicyEmployeeCollectionV1Inner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeTracking_BreakPolicyEmployeeCollection_V1_inner';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string $name The employee name {Preferred Last}
	 *
	 * @return self
	 */
	 ...
	 * Sets photo_url
	 *
	 * @param string $photo_url The employee profile photo
	 *
	 * @return self
	 */
