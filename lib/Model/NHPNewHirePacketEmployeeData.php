...
/**
 * NHPNewHirePacketEmployeeData Class Doc Comment
 *
 * @category Class
 ...
 */
class NHPNewHirePacketEmployeeData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NHP-NewHirePacketEmployeeData';
    ...
    */
     ...
     * Sets hire_date
     *
     * @param string|null $hire_date Hire date of the employee
     *
     * @return self
     */
     ...
     * Sets job_location
     *
     * @param string|null $job_location Job location of the employee
     *
     * @return self
     */
    public function setJobLocation($job_location)
    {
        if (is_null($job_location)) {
            throw new \InvalidArgumentException('non-nullable job_location cannot be null');
        }
     ...
     * Sets manager_id
     *
     * @param int|null $manager_id Unique identifier of the employee's manager
     *
     * @return self
     */
