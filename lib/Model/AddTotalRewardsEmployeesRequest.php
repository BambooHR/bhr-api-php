...
/**
 * AddTotalRewardsEmployeesRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class AddTotalRewardsEmployeesRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'add_total_rewards_employees_request';
	...
	*/
	 ...
	 * Sets employee_ids
	 *
	 * @param int[] $employee_ids List of employee IDs to add to Total Rewards.
	 *
	 * @return self
	 */
