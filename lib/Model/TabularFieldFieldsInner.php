...
/**
 * TabularFieldFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class TabularFieldFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TabularField_fields_inner';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string|null $name The display name of the field.
	 *
	 * @return self
	 */
	 ...
	 * Sets alias
	 *
	 * @param string|null $alias The API alias for the field within this table.
	 *
	 * @return self
	 */
	 ...
	 * Sets type
	 *
	 * @param string|null $type The data type of the field (e.g., text, date, list).
	 *
	 * @return self
	 */
