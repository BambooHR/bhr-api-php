...
/**
 * NewHirePacketGtkyAnswerVisibilityItem Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class NewHirePacketGtkyAnswerVisibilityItem implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'NewHirePacketGtkyAnswerVisibilityItem';
	...
	*/
	...
	public function setHidden($hidden) {
		if (is_null($hidden)) {
			$this->openApiNullablesSetToNull['hidden'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['hidden'])) {
				unset($nullablesSetToNull['hidden']);
