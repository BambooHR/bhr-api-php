...
/**
 * ProjectPaginatedResponseDataV1LinksNext Class Doc Comment
 *
 * @category Class
 * @description Link object for the next page. Omitted on the last page.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectPaginatedResponseDataV1LinksNext implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Project_PaginatedResponseData_V1__links_next';
