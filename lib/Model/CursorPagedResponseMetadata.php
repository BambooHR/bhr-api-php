...
/**
 * CursorPagedResponseMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class CursorPagedResponseMetadata implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CursorPagedResponseMetadata';
	...
	protected static $openApiTypes = [
		'total' => 'int',
		'page' => '\BhrSdk\Model\CursorPagesResponse'
	];
	...
	*/
	 ...
	 * Sets total
	 *
	 * @param int $total Total number of employees matching the filter criteria
	 *
	 * @return self
	 */
	 ...
	 * Gets page
	 *
	 * @return \BhrSdk\Model\CursorPagesResponse
	 */
	 ...
	 * Sets page
	 *
	 * @param \BhrSdk\Model\CursorPagesResponse $page Pagination information for the current response
	 *
	 * @return self
	 */
