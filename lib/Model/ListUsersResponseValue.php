...
/**
 * ListUsersResponseValue Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListUsersResponseValue implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ListUsersResponse_value';
	...
	*/
	 ...
	 * Sets employee_id
	 *
	 * @param int|null $employee_id The ID of the employee record linked to this user. Always present in the JSON response; `0` when no employee record is associated.
	 *
	 * @return self
	 */
	 ...
	 * Sets email
	 *
	 * @param string|null $email The user's email address. Resolved in priority order: work email, home email, account email.
	 *
	 * @return self
	 */
	 ...
	 * Sets last_login
	 *
	 * @param \DateTime|null $last_login ISO 8601 timestamp of the most recent login. Omitted when the user has never logged in.
	 *
	 * @return self
	 */
