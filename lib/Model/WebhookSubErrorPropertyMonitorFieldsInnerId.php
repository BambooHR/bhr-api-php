...
/**
 * WebhookSubErrorPropertyMonitorFieldsInnerId Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class WebhookSubErrorPropertyMonitorFieldsInnerId implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'WebhookSubErrorProperty_monitorFields_inner_id';
