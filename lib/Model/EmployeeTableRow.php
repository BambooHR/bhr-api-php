...
/**
 * EmployeeTableRow Class Doc Comment
 *
 * @category Class
 ...
 */
class EmployeeTableRow implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeTableRow';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id The table row ID.
	 *
	 * @return self
	 */
	 ...
	 * Sets employee_id
	 *
	 * @param string|null $employee_id The employee ID that owns this row.
	 *
	 * @return self
	 */
