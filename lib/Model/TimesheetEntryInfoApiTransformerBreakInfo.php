...
/**
 * TimesheetEntryInfoApiTransformerBreakInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class TimesheetEntryInfoApiTransformerBreakInfo implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimesheetEntryInfoApiTransformer_breakInfo';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string|null $name Break name
	 *
	 * @return self
	 */
