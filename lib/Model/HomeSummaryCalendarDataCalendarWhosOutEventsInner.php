<?php
/**
 * HomeSummaryCalendarDataCalendarWhosOutEventsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * HomeSummaryCalendarDataCalendarWhosOutEventsInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class HomeSummaryCalendarDataCalendarWhosOutEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HomeSummaryCalendarData_calendar_whosOut_events_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Time off request ID.
     *
     * @return self
     */
     ...
     *
     * @param int|null $time_off_type_id Type of time off.
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param \DateTime|null $start Start date of the time off.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime|null $end End date of the time off.
     *
     * @return self
     */
