...
/**
 * TotalRewardsHolidayValue Class Doc Comment
 *
 * @category Class
 ...
 */
class TotalRewardsHolidayValue implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TotalRewards-HolidayValue';
