...
/**
 * WebhookLogRateLimitResponseError Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class WebhookLogRateLimitResponseError implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'WebhookLogRateLimitResponse_error';
