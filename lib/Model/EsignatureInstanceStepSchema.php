...
/**
 * EsignatureInstanceStepSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class EsignatureInstanceStepSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EsignatureInstanceStepSchema';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'fields' => '\MySdk\Model\EsignatureInstanceFieldSchema[]'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for the eSignature instance step
     *
     * @return self
     */
     ...
     *
     * @param int|null $esignature_instance_id ID of the associated eSignature instance
     *
     * @return self
     */
    public function setEsignatureInstanceId($esignature_instance_id)
    {
        if (is_null($esignature_instance_id)) {
            throw new \InvalidArgumentException('non-nullable esignature_instance_id cannot be null');
        }
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order Sort order of the eSignature instance step
     *
     * @return self
     */
     ...
     *
     * @param int|null $assigned_user_id ID of the user assigned to the eSignature instance step
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the eSignature instance step
     *
     * @return self
     */
     ...
     * Gets fields
     *
     * @return \MySdk\Model\EsignatureInstanceFieldSchema[]|null
     */
     ...
     * Sets fields
     *
     * @param \MySdk\Model\EsignatureInstanceFieldSchema[]|null $fields Fields associated with the eSignature instance step
     *
     * @return self
     */
