...
/**
 * PayGradesAndBandsUpdatePayBandsResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class PayGradesAndBandsUpdatePayBandsResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'PayGradesAndBandsUpdatePayBandsResponse';
