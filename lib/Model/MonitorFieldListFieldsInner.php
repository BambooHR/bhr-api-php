...
/**
 * MonitorFieldListFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class MonitorFieldListFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'MonitorFieldList_fields_inner';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string $id The field ID, returned as a string.
	 *
	 * @return self
	 */
	 ...
	 * Sets name
	 *
	 * @param string $name The human-readable field name.
	 *
	 * @return self
	 */
