...
/**
 * NewHirePacketGtkyAnswerVisibilityRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class NewHirePacketGtkyAnswerVisibilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'NewHirePacketGtkyAnswerVisibilityRequest';
	...
	*/
	 ...
	 * Sets hidden
	 *
	 * @param bool $hidden When true, answers are hidden from typical manager views; when false, answers are shown.
	 *
	 * @return self
	 */
	 ...
	 * Sets question_ids
	 *
	 * @param int[]|null $question_ids question_ids
	 *
	 * @return self
	 */
	public function setQuestionIds($question_ids) {
		if (is_null($question_ids)) {
			$this->openApiNullablesSetToNull['question_ids'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['question_ids'])) {
				unset($nullablesSetToNull['question_ids']);
