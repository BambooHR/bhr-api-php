<?php
/**
 * PayrollExtraPayControllerOneTimeExtraPayEntry
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PayrollExtraPayControllerOneTimeExtraPayEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class PayrollExtraPayControllerOneTimeExtraPayEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payroll.ExtraPayController.OneTimeExtraPayEntry';
    ...
    */
     ...
     * Sets frequency
     *
     * @param string|null $frequency Payment frequency (one-time)
     *
     * @return self
     */
    ...
    public function setPayCycleId($pay_cycle_id)
    {
        if (is_null($pay_cycle_id)) {
            array_push($this->openAPINullablesSetToNull, 'pay_cycle_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pay_cycle_id', $nullablesSetToNull);
            if ($index !== FALSE) {
