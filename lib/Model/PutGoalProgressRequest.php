...
/**
 * PutGoalProgressRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class PutGoalProgressRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'put_goal_progress_request';
	...
	*/
	...
	public function setPercentComplete($percent_complete) {
		...
		if (($percent_complete > 100)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling PutGoalProgressRequest., must be smaller than or equal to 100.');
		}
		if (($percent_complete < 0)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling PutGoalProgressRequest., must be bigger than or equal to 0.');
		}
