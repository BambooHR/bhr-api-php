<?php
/**
 * HighestPriorityCurrentTaxSetupStatusViewObjectTaxType
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * HighestPriorityCurrentTaxSetupStatusViewObjectTaxType Class Doc Comment
 *
 * @category Class
 ...
 */
class HighestPriorityCurrentTaxSetupStatusViewObjectTaxType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HighestPriorityCurrentTaxSetupStatusViewObject_taxType';
    ...
    protected static array $openAPINullables = [
        'id' => true,
        'client_id' => true,
        'client_tax_type_include_id' => true,
        'tax_type' => true,
        'tax_payer' => true
    ];
    ...
    public const TAX_PAYER_EE = 'EE';
    public const TAX_PAYER_ER = 'ER';
    ...
    */
     ...
     *
     * @param int|null $client_tax_type_include_id client_tax_type_include_id
     *
     * @return self
     */
    public function setClientTaxTypeIncludeId($client_tax_type_include_id)
    {
        if (is_null($client_tax_type_include_id)) {
            array_push($this->openAPINullablesSetToNull, 'client_tax_type_include_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('client_tax_type_include_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets tax_payer
     *
     * @param string|null $tax_payer tax_payer
     *
     * @return self
     */
    public function setTaxPayer($tax_payer)
    {
        if (is_null($tax_payer)) {
            array_push($this->openAPINullablesSetToNull, 'tax_payer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tax_payer', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getTaxPayerAllowableValues();
        if (!is_null($tax_payer) && !in_array($tax_payer, $allowedValues, true)) {
