...
/**
 * ListUsersXmlResponseUserInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListUsersXmlResponseUserInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ListUsersXmlResponse_user_inner';
	...
	*/
	 ...
	 * Sets employee_id
	 *
	 * @param int|null $employee_id The employee record ID. Present as an XML attribute only when the user has an associated employee record.
	 *
	 * @return self
	 */
