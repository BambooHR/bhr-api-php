<?php
/**
 * EsignatureEsignatureTemplateFieldSchema
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * EsignatureEsignatureTemplateFieldSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class EsignatureEsignatureTemplateFieldSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Esignature-EsignatureTemplateFieldSchema';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for the template field.
     *
     * @return self
     */
     ...
     * Sets top_percent
     *
     * @param float|null $top_percent Vertical position of the field as a percentage of the page height.
     *
     * @return self
     */
     ...
     * Sets left_percent
     *
     * @param float|null $left_percent Horizontal position of the field as a percentage of the page width.
     *
     * @return self
     */
     ...
     * Sets height_percent
     *
     * @param float|null $height_percent Height of the field as a percentage of the page height.
     *
     * @return self
     */
     ...
     * Sets width_percent
     *
     * @param float|null $width_percent Width of the field as a percentage of the page width.
     *
     * @return self
     */
     ...
     * Sets field_type
     *
     * @param string|null $field_type Type of the field, e.g., text, checkbox.
     *
     * @return self
     */
     ...
     * Sets group_id
     *
     * @param int|null $group_id Identifier for the group this field belongs to, if any.
     *
     * @return self
     */
     ...
     * Sets group_mode
     *
     * @param string|null $group_mode Mode of the group, e.g., only one checked, at least one checked.
     *
     * @return self
     */
     ...
     * Sets tab_order
     *
     * @param int|null $tab_order Tab order for navigating through fields.
     *
     * @return self
     */
     ...
     * Sets field_id
     *
     * @param int|null $field_id Identifier for the field, if applicable.
     *
     * @return self
     */
     ...
     * Sets sub_field_id
     *
     * @param int|null $sub_field_id Identifier for the sub-field, if applicable.
     *
     * @return self
     */
