...
/**
 * LocationResponseObjectAddressCountry Class Doc Comment
 *
 * @category Class
 ...
 */
class LocationResponseObjectAddressCountry implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LocationResponseObject_address_country';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id Country identifier
	 *
	 * @return self
	 */
	 ...
	 * Sets iso_code
	 *
	 * @param string|null $iso_code Country ISO code
	 *
	 * @return self
	 */
