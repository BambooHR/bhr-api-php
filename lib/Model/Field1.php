 ...
 */
class Field1 implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Field_1';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param \BhrSdk\Model\Field1Id $id id
	 *
	 * @return self
	 */
	 ...
	 * Sets type
	 *
	 * @param string $type The data type of the field (e.g., text, date, list, checkbox).
	 *
	 * @return self
	 */
	 ...
	 * Sets alias
	 *
	 * @param string|null $alias The API alias for the field. Only present when the field has an alias.
	 *
	 * @return self
	 */
	 ...
	 * Sets deprecated
	 *
	 * @param bool|null $deprecated Whether the field is deprecated and should no longer be used. Only present for deprecated fields.
	 *
	 * @return self
	 */
