 ...
 */
class BankHoliday implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'BankHoliday';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id Stable bank holiday identifier
	 *
	 * @return self
	 */
	 ...
	 * Sets name
	 *
	 * @param string|null $name Holiday display name
	 *
	 * @return self
	 */
	 ...
	 * Sets date
	 *
	 * @param \DateTime|null $date Holiday date in YYYY-MM-DD form
	 *
	 * @return self
	 */
