...
/**
 * DatasetsResponseDatasetsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class DatasetsResponseDatasetsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'DatasetsResponse_datasets_inner';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string|null $name Internal name identifier for the dataset
	 *
	 * @return self
	 */
	 ...
	 * Sets label
	 *
	 * @param string|null $label Human-readable label for the dataset
	 *
	 * @return self
	 */
