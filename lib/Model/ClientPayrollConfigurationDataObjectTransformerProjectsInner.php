<?php
/**
 * ClientPayrollConfigurationDataObjectTransformerProjectsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ClientPayrollConfigurationDataObjectTransformerProjectsInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class ClientPayrollConfigurationDataObjectTransformerProjectsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientPayrollConfigurationDataObjectTransformer_projects_inner';
    ...
    */
     ...
     *
     * @param int|null $client_job_category_id The ID of the client job category
     *
     * @return self
     */
