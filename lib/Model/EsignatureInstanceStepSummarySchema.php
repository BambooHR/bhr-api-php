...
/**
 * EsignatureInstanceStepSummarySchema Class Doc Comment
 *
 * @category Class
 ...
 */
class EsignatureInstanceStepSummarySchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EsignatureInstanceStepSummarySchema';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier of the step
     *
     * @return self
     */
     ...
     *
     * @param int|null $esignature_instance_id ID of the associated e-signature instance
     *
     * @return self
     */
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order The order in which the step appears in the e-signature process
     *
     * @return self
     */
     ...
     *
     * @param int|null $assigned_user_id ID of the user assigned to this step, if any
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Current status of the step
     *
     * @return self
     */
