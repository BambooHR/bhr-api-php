...
/**
 * ChatMessageFeedbackDataObject Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatMessageFeedbackDataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatMessageFeedbackDataObject';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unhelpful', $data ?? [], null);
        $this->setIfExists('harmful', $data ?? [], null);
    ...
    */
     ...
     * Sets incorrect
     *
     * @param bool|null $incorrect Flags the response as incorrect
     *
     * @return self
     */
    ...
    {
        return $this->container['unhelpful'];
    }

    /**
     * Sets unhelpful
     *
     * @param bool|null $unhelpful Flags the response as unhelpful
     *
     * @return self
     */
    public function setUnhelpful($unhelpful)
    {
        if (is_null($unhelpful)) {
            throw new \InvalidArgumentException('non-nullable unhelpful cannot be null');
        }
        $this->container['unhelpful'] = $unhelpful;
     ...
     * Sets harmful
     *
     * @param bool|null $harmful Flags the response as harmful
     *
     * @return self
     */
    ...
    {
        if (is_null($harmful)) {
            throw new \InvalidArgumentException('non-nullable harmful cannot be null');
        }
     ...
     * Sets comment
     *
     * @param string|null $comment Any feedback related comments about the response
     *
     * @return self
     */
     ...
     * Sets rating
     *
     * @param string|null $rating Gives a thumbs-up / thumbs-down rating for the message
     *
     * @return self
     */
    public function setRating($rating)
    {
        ...
        $allowedValues = $this->getRatingAllowableValues();
        if (!is_null($rating) && !in_array($rating, $allowedValues, true)) {
