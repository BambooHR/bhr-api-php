...
/**
 * UpdateGoalV11Request Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateGoalV11Request implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_goal_v1_1_request';
	...
	protected static $openApiTypes = [
		...
		'milestones' => '\BhrSdk\Model\UpdateGoalV11RequestMilestonesInner[]'
	];
	...
	*/
	 ...
	 *
	 * @param int|null $percent_complete The percentage of completion for the goal (0-100). Defaults to 0 if omitted. Ignored when milestonesEnabled is true.
	 *
	 * @return self
	 */
	public function setPercentComplete($percent_complete) {
		...
		if (($percent_complete > 100)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling UpdateGoalV11Request., must be smaller than or equal to 100.');
		}
		if (($percent_complete < 0)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling UpdateGoalV11Request., must be bigger than or equal to 0.');
		}
	 ...
	 * Gets milestones
	 *
	 * @return \BhrSdk\Model\UpdateGoalV11RequestMilestonesInner[]|null
	 */
	 ...
	 * Sets milestones
	 *
	 * @param \BhrSdk\Model\UpdateGoalV11RequestMilestonesInner[]|null $milestones Optional. New milestones to add to the goal. Each object in this array creates a new milestone — even if its title matches an existing milestone. Do not include existing milestones here unless you intentionally want duplicates. To remove milestones, use `deletedMilestoneIds`.
	 *
	 * @return self
	 */
