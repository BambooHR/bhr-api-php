 ...
 */
class TimesheetEntryInfoApiTransformer implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimesheetEntryInfoApiTransformer';
