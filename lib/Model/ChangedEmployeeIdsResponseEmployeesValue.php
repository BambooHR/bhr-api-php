...
/**
 * ChangedEmployeeIdsResponseEmployeesValue Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ChangedEmployeeIdsResponseEmployeesValue implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ChangedEmployeeIdsResponse_employees_value';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id The employee ID.
	 *
	 * @return self
	 */
	 ...
	 * Sets action
	 *
	 * @param string|null $action The type of change: Inserted, Updated, or Deleted.
	 *
	 * @return self
	 */
	 ...
	 * Sets last_changed
	 *
	 * @param \DateTime|null $last_changed ISO 8601 timestamp of the last change.
	 *
	 * @return self
	 */
