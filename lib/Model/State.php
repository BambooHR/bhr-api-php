...
class State implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	public function __construct(?array $data = null) {
		...
		$this->setIfExists('abbrev', $data ?? [], null);
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id The ID of the state
	 *
	 * @return self
	 */
	...
	public function getAbbrev() {
		return $this->container['abbrev'];
	}

	/**
	 * Sets abbrev
	 *
	 * @param string|null $abbrev The abbreviation of the state
	 *
	 * @return self
	 */
	public function setAbbrev($abbrev) {
		if (is_null($abbrev)) {
			throw new \InvalidArgumentException('non-nullable abbrev cannot be null');
		}
		$this->container['abbrev'] = $abbrev;
	 ...
	 * Sets iso_code
	 *
	 * @param string|null $iso_code The ISO standard code of the state
	 *
	 * @return self
	 */
