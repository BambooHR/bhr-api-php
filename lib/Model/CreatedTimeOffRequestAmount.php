...
/**
 * CreatedTimeOffRequestAmount Class Doc Comment
 *
 * @category Class
 * @description The amount of time off requested. Only present when the underlying time off type record could be loaded.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreatedTimeOffRequestAmount implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CreatedTimeOffRequest_amount';
	...
	*/
	 ...
	 * Sets amount
	 *
	 * @param float|null $amount The total amount requested.
	 *
	 * @return self
	 */
