 ...
 */
class TimeTrackingProjectWithTasksAndEmployeeIds implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeTrackingProjectWithTasksAndEmployeeIds';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id ID of the project.
	 *
	 * @return self
	 */
	 ...
	 * Sets employee_ids
	 *
	 * @param int[]|null $employee_ids A list of employee IDs that can log time for this project. If not present, all employees can log time for the project.
	 *
	 * @return self
	 */
