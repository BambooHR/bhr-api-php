...
/**
 * CompensationEquitySettingsResponseDisclaimers Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationEquitySettingsResponseDisclaimers implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationEquitySettingsResponse_disclaimers';
