...
/**
 * AdjustTimeOffBalance Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class AdjustTimeOffBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdjustTimeOffBalance';
    ...
    */
     ...
     *
     * @param int $time_off_type_id The ID of the time off type to add a balance adjustment for.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount The number of hours/days to adjust the balance by.
     *
     * @return self
     */
