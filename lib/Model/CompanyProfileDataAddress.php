...
/**
 * CompanyProfileDataAddress Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompanyProfileDataAddress implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompanyProfileData_address';
	...
	*/
	...
	public function setZip($zip) {
		if (is_null($zip)) {
			$this->openApiNullablesSetToNull['zip'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['zip'])) {
				unset($nullablesSetToNull['zip']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
