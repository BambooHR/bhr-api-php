...
/**
 * EmployeeTimeOffPolicyAssignment Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeTimeOffPolicyAssignment implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeTimeOffPolicyAssignment';
	...
	*/
	 ...
	 *
	 * @param \DateTime|null $accrual_start_date The date accruals started in YYYY-MM-DD format.
	 *
	 * @return self
	 */
