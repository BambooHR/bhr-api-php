...
/**
 * LoginFailureXmlResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class LoginFailureXmlResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LoginFailureXmlResponse';
	...
	*/
	 ...
	 * Sets response
	 *
	 * @param string|null $response Always `declined`.
	 *
	 * @return self
	 */
