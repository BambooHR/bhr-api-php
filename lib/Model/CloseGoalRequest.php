...
/**
 * CloseGoalRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CloseGoalRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'close_goal_request';
	...
	*/
	...
	public function setComment($comment) {
		if (is_null($comment)) {
			$this->openApiNullablesSetToNull['comment'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['comment'])) {
				unset($nullablesSetToNull['comment']);
