...
/**
 * EmployeeDeletedWebhookPayloadData Class Doc Comment
 *
 * @category Class
 ...
 */
class EmployeeDeletedWebhookPayloadData implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeDeletedWebhookPayload_data';
	...
	*/
	 ...
	 * Sets employee_id
	 *
	 * @param string|null $employee_id The employee ID that was deleted
	 *
	 * @return self
	 */
