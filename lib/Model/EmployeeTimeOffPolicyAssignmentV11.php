...
/**
 * EmployeeTimeOffPolicyAssignmentV11 Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeTimeOffPolicyAssignmentV11 implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeTimeOffPolicyAssignmentV1_1';
	...
	*/
	 ...
	 *
	 * @param int|null $time_off_policy_id The ID of the assigned time off policy.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param int|null $time_off_type_id The ID of the time off type.
	 *
	 * @return self
	 */
