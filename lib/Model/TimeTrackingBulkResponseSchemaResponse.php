...
/**
 * TimeTrackingBulkResponseSchemaResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class TimeTrackingBulkResponseSchemaResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeTrackingBulkResponseSchema_response';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id Unique identifier for the time tracking record
	 *
	 * @return self
	 */
