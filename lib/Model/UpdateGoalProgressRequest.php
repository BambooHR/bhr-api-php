...
/**
 * UpdateGoalProgressRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateGoalProgressRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_goal_progress_request';
	...
	*/
	...
	public function setPercentComplete($percent_complete) {
		...
		if (($percent_complete > 100)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling UpdateGoalProgressRequest., must be smaller than or equal to 100.');
		}
		if (($percent_complete < 0)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling UpdateGoalProgressRequest., must be bigger than or equal to 0.');
		}
