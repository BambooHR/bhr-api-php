...
/**
 * DatasetsResponseV12DatasetsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class DatasetsResponseV12DatasetsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Datasets_Response__v1_2__datasets_inner';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string|null $name Machine-readable dataset identifier, used as the datasetName path parameter in other Datasets endpoints.
	 *
	 * @return self
	 */
