...
/**
 * LevelsAndBandsGroup Class Doc Comment
 *
 * @category Class
 ...
 */
class LevelsAndBandsGroup implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LevelsAndBands-Group';
	...
	protected static $openApiTypes = [
		'id' => 'int',
		'group_name' => 'string',
		'levels' => '\BhrSdk\Model\LevelsAndBandsLevel[]'
	];
	...
	*/
	...
	public function setGroupName($group_name) {
		if (is_null($group_name)) {
			$this->openApiNullablesSetToNull['group_name'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['group_name'])) {
				unset($nullablesSetToNull['group_name']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
	 ...
	 * Gets levels
	 *
	 * @return \BhrSdk\Model\LevelsAndBandsLevel[]|null
	 */
	 ...
	 * Sets levels
	 *
	 * @param \BhrSdk\Model\LevelsAndBandsLevel[]|null $levels Array of levels in this group
	 *
	 * @return self
	 */
