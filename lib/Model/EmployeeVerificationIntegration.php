...
/**
 * EmployeeVerificationIntegration Class Doc Comment
 *
 * @category Class
 * @description Install state and partner metadata for the company&#39;s employee verification integration.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EmployeeVerificationIntegration implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeVerificationIntegration';
	...
	*/
	 ...
	 * Sets enabled
	 *
	 * @param bool $enabled True when the integration is installed for the company and partner endpoints are usable.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param string $integration_type Identifier of the configured employee verification partner (opaque string; matches `integrationType` from the integration GET response).
	 *
	 * @return self
	 */
