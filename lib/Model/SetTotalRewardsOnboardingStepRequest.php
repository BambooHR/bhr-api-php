...
/**
 * SetTotalRewardsOnboardingStepRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SetTotalRewardsOnboardingStepRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'set_total_rewards_onboarding_step_request';
