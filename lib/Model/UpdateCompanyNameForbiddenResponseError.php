...
/**
 * UpdateCompanyNameForbiddenResponseError Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCompanyNameForbiddenResponseError implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'UpdateCompanyNameForbiddenResponse_error';
