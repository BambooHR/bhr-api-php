...
/**
 * JobSummaryStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class JobSummaryStatus implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'JobSummary_status';
