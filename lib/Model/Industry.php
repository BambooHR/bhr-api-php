 ...
 */
class Industry implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Industry';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string|null $name Industry name
	 *
	 * @return self
	 */
