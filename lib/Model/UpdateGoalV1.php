...
/**
 * UpdateGoalV1 Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateGoalV1 implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'UpdateGoalV1';
	...
	*/
	 ...
	 * Sets title
	 *
	 * @param string $title [Required] The goal title.
	 *
	 * @return self
	 */
	 ...
	 * Sets description
	 *
	 * @param string|null $description [Optional] The goal description. If omitted, the existing value will be overwritten with an empty string.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param int|null $percent_complete [Optional] The goal completion percentage (0-100). If omitted, the existing value will be overwritten with 0.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param int[] $shared_with_employee_ids [Required] Employee IDs of employees with whom the goal is shared. All goal owners are considered \"shared with\". This must include the employee for whom the goal is created.
	 *
	 * @return self
	 */
	 ...
	 * Sets due_date
	 *
	 * @param \DateTime $due_date [Required] The goal due date in YYYY-MM-DD format.
	 *
	 * @return self
	 */
