...
/**
 * ProjectTimeTrackingTaskV1 Class Doc Comment
 *
 * @category Class
 * @description A task within a time tracking project. Tasks are sub-organizational units used to further classify hours worked.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectTimeTrackingTaskV1 implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Project-TimeTrackingTask-V1';
	...
	*/
	 ...
	 * Sets project_id
	 *
	 * @param int|null $project_id The ID of the project this task belongs to.
	 *
	 * @return self
	 */
	 ...
	 * Sets billable
	 *
	 * @param bool|null $billable Whether the task is billable.
	 *
	 * @return self
	 */
