...
/**
 * CreatePayrollContactTransformer Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePayrollContactTransformer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePayrollContactTransformer';
    ...
    */
    ...
    public function setWorkPhoneExtension($work_phone_extension)
    {
        if (is_null($work_phone_extension)) {
            array_push($this->openAPINullablesSetToNull, 'work_phone_extension');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('work_phone_extension', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets user_id
     *
     * @param int|null $user_id BambooHR User ID of the payroll contact.
     *
     * @return self
     */
     ...
     * Sets contact_id
     *
     * @param int|null $contact_id Contact ID of the payroll contact.
     *
     * @return self
     */
