<?php
/**
 * InboxDetailsWithPersonsCommentsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InboxDetailsWithPersonsCommentsInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class InboxDetailsWithPersonsCommentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboxDetailsWithPersons_comments_inner';
    ...
    */
     ...
     *
     * @param \DateTime|null $created_datetime created_datetime
     *
     * @return self
     */
    ...
    public function setReplyToId($reply_to_id)
    {
        if (is_null($reply_to_id)) {
            array_push($this->openAPINullablesSetToNull, 'reply_to_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reply_to_id', $nullablesSetToNull);
            if ($index !== FALSE) {
