...
/**
 * GetCompanyReportResponseEmployeesInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class GetCompanyReportResponseEmployeesInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'GetCompanyReportResponse_employees_inner';
