...
/**
 * PayGradesAndBandsUpdateJobTitlesResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class PayGradesAndBandsUpdateJobTitlesResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'PayGradesAndBandsUpdateJobTitlesResponse';
