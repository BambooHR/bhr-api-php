...
/**
 * 43c7cc099ca54295a047f449824fc0ddRequest Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class 43c7cc099ca54295a047f449824fc0ddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_43c7cc099ca54295a047f449824fc0dd_request';
    ...
    */
    ...
    public function setStart($start)
    {
        ...
        if ((!preg_match("/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/", ObjectSerializer::toString($start)))) {
            throw new \InvalidArgumentException("invalid value for \$start when calling 43c7cc099ca54295a047f449824fc0ddRequest., must conform to the pattern /^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.");
        }
