...
/**
 * EmployeePaySchedule Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeePaySchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeePaySchedule';
    ...
    protected static array $openAPINullables = [
        ...
        'pay_schedule_list_value_id' => false
    ];
    ...
    */
     ...
     * Sets client_id
     *
     * @param int|null $client_id External company ID
     *
     * @return self
     */
     ...
     * Sets pay_group_id
     *
     * @param int|null $pay_group_id External pay schedule ID
     *
     * @return self
     */
    ...
    public function setPayScheduleListValueId($pay_schedule_list_value_id)
    {
        if (is_null($pay_schedule_list_value_id)) {
            throw new \InvalidArgumentException('non-nullable pay_schedule_list_value_id cannot be null');
        }
