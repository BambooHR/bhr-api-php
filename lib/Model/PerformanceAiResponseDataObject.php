...
/**
 * PerformanceAiResponseDataObject Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PerformanceAiResponseDataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PerformanceAiResponseDataObject';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the response
     *
     * @return self
     */
     ...
     * Sets feature_type
     *
     * @param int|null $feature_type Type of the feature
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string|null $response Response content
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $created_date_time Creation date and time
     *
     * @return self
     */
