...
/**
 * ProvinceItem Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class ProvinceItem implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ProvinceItem';
	...
	*/
	 ...
	 * Sets country_id
	 *
	 * @param string|null $country_id ID of the country this state/province belongs to
	 *
	 * @return self
	 */
	 ...
	 * Sets label
	 *
	 * @param string|null $label State/province abbreviation (e.g. \"UT\")
	 *
	 * @return self
	 */
	 ...
	 * Sets iso
	 *
	 * @param string|null $iso ISO 3166-2 code (e.g. \"US-UT\")
	 *
	 * @return self
	 */
