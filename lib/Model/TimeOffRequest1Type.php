...
/**
 * TimeOffRequest1Type Class Doc Comment
 *
 * @category Class
 * @description The time off type for this request.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TimeOffRequest1Type implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeOffRequest_1_type';
	...
	*/
	 ...
	 * Sets icon
	 *
	 * @param string|null $icon The icon name for the time off type.
	 *
	 * @return self
	 */
