...
/**
 * UpdateTrainingTypeRequestCategory Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateTrainingTypeRequestCategory implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_training_type_request_category';
