...
/**
 * CompanyIntegrationsUpdatedWebhookPayloadData Class Doc Comment
 *
 * @category Class
 ...
 */
class CompanyIntegrationsUpdatedWebhookPayloadData implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompanyIntegrationsUpdatedWebhookPayload_data';
