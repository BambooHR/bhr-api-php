...
/**
 * LevelsAndBandsJobTitleAssignment Class Doc Comment
 *
 * @category Class
 * @description Job title assignment to a level
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LevelsAndBandsJobTitleAssignment implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LevelsAndBands-JobTitleAssignment';
	...
	*/
	 ...
	 * Sets level_id
	 *
	 * @param int|null $level_id Compensation level id
	 *
	 * @return self
	 */
