...
/**
 * CompensationBenchmarkJobLocationPairJobDetails Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationBenchmarkJobLocationPairJobDetails implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationBenchmarkJobLocationPair_jobDetails';
