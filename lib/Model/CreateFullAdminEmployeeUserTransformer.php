...
/**
 * CreateFullAdminEmployeeUserTransformer Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateFullAdminEmployeeUserTransformer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFullAdminEmployeeUserTransformer';
    ...
    */
     ...
     * Sets user_id
     *
     * @param int|null $user_id User ID of the created employee
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param int|null $employee_id Employee ID of the created employee
     *
     * @return self
     */
     ...
     * Sets work_email
     *
     * @param string|null $work_email Work email of the employee
     *
     * @return self
     */
     ...
     * Sets work_phone
     *
     * @param string|null $work_phone Work phone number of the employee
     *
     * @return self
     */
