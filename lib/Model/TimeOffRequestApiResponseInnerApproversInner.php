<?php
/**
 * TimeOffRequestApiResponseInnerApproversInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * TimeOffRequestApiResponseInnerApproversInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class TimeOffRequestApiResponseInnerApproversInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeOffRequestApiResponse_inner_approvers_inner';
    ...
    protected static $openAPITypes = [
        'approvers' => '\MySdk\Model\EmployeeTimeOffRequestApproverResponseInner[]',
    ...
    */
     ...
     * Gets approvers
     *
     * @return \MySdk\Model\EmployeeTimeOffRequestApproverResponseInner[]|null
     */
     ...
     * Sets approvers
     *
     * @param \MySdk\Model\EmployeeTimeOffRequestApproverResponseInner[]|null $approvers List of time off request approvers
     *
     * @return self
     */
    ...
    public function setApproverEmployeeId($approver_employee_id)
    {
        if (is_null($approver_employee_id)) {
            throw new \InvalidArgumentException('non-nullable approver_employee_id cannot be null');
        }
