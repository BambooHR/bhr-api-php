<?php
/**
 * PayrollSnapshotTransformerEarningsByIdValue
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PayrollSnapshotTransformerEarningsByIdValue Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayrollSnapshotTransformerEarningsByIdValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayrollSnapshotTransformer_earnings_byId_value';
    ...
    */
     ...
     * Sets earning_id
     *
     * @param int|null $earning_id Earning ID
     *
     * @return self
     */
     ...
     * Sets hour_type_id
     *
     * @param int|null $hour_type_id Hour type ID
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Quantity of hours or units
     *
     * @return self
     */
     ...
     *
     * @param float|null $original_quantity Original quantity before adjustments
     *
     * @return self
     */
     ...
     * Sets original_rate
     *
     * @param float|null $original_rate Original rate before adjustments
     *
     * @return self
     */
     ...
     *
     * @param int|null $client_holiday_id Client holiday ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $earning_sub_type Subtype of the earning
     *
     * @return self
     */
