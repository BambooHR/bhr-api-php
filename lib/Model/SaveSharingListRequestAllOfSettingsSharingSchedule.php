<?php
/**
 * SaveSharingListRequestAllOfSettingsSharingSchedule
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * SaveSharingListRequestAllOfSettingsSharingSchedule Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class SaveSharingListRequestAllOfSettingsSharingSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveSharingListRequest_allOf_settings_sharingSchedule';
     ...
     * @return string[]
     */
    public function getIntervalUnitAllowableValues()
    {
        return [
            self::INTERVAL_UNIT_DAY,
            self::INTERVAL_UNIT_WEEK,
            self::INTERVAL_UNIT_MONTH,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['interval_unit'] === null) {
            $invalidProperties[] = "'interval_unit' can't be null";
        }
        $allowedValues = $this->getIntervalUnitAllowableValues();
        if (!is_null($this->container['interval_unit']) && !in_array($this->container['interval_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'interval_unit', must be one of '%s'",
                $this->container['interval_unit'],
    ...
    public function setIntervalUnit($interval_unit)
    {
        ...
        $allowedValues = $this->getIntervalUnitAllowableValues();
        if (!in_array($interval_unit, $allowedValues, true)) {
