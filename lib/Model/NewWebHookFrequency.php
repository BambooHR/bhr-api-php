...
/**
 * NewWebHookFrequency Class Doc Comment
 *
 * @category Class
 ...
 */
class NewWebHookFrequency implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'NewWebHook_frequency';
	...
	*/
	 ...
	 * Sets hour
	 *
	 * @param int|null $hour The hour to potentially fire (0-23, null to potentially fire every hour)
	 *
	 * @return self
	 */
	 ...
	 * Sets minute
	 *
	 * @param int|null $minute The minute to potentially fire (0-59, null to potentially fire every minute)
	 *
	 * @return self
	 */
	 ...
	 * Sets day
	 *
	 * @param int|null $day The day to potentially fire (1-31, null to potentially fire every day)
	 *
	 * @return self
	 */
	 ...
	 * Sets month
	 *
	 * @param int|null $month The month to potentially fire (1-12, null to potentially fire every month)
	 *
	 * @return self
	 */
