 ...
 */
class GetEmployeesList400ResponseError implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'get_employees_list_400_response_error';
