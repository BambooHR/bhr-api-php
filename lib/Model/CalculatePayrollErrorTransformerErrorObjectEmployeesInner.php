<?php
/**
 * CalculatePayrollErrorTransformerErrorObjectEmployeesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CalculatePayrollErrorTransformerErrorObjectEmployeesInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class CalculatePayrollErrorTransformerErrorObjectEmployeesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalculatePayrollErrorTransformer_errorObject_employees_inner';
    ...
    protected static $openAPITypes = [
        ...
        'pay_types' => 'string[]',
        'check_id' => 'int',
        'earnings' => '\MySdk\Model\CalculatePayrollErrorTransformerErrorObjectEmployeesInnerEarningsInner[]'
    ];
    ...
    */
     ...
     * Sets page_url
     *
     * @param string|null $page_url URL to employee's page
     *
     * @return self
     */
     ...
     * Gets earnings
     *
     * @return \MySdk\Model\CalculatePayrollErrorTransformerErrorObjectEmployeesInnerEarningsInner[]|null
     */
     ...
     * Sets earnings
     *
     * @param \MySdk\Model\CalculatePayrollErrorTransformerErrorObjectEmployeesInnerEarningsInner[]|null $earnings Employee's earnings data
     *
     * @return self
     */
    ...
    {
        if (is_null($earnings)) {
            array_push($this->openAPINullablesSetToNull, 'earnings');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('earnings', $nullablesSetToNull);
            if ($index !== FALSE) {
