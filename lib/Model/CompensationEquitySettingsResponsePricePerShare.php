...
/**
 * CompensationEquitySettingsResponsePricePerShare Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationEquitySettingsResponsePricePerShare implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationEquitySettingsResponse_pricePerShare';
