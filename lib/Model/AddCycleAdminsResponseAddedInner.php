...
/**
 * AddCycleAdminsResponseAddedInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class AddCycleAdminsResponseAddedInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'AddCycleAdminsResponse_added_inner';
