...
/**
 * RequestCustomReportResponseEmployeesInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class RequestCustomReportResponseEmployeesInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'RequestCustomReportResponse_employees_inner';
