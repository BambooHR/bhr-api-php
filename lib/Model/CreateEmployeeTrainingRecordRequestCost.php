...
/**
 * CreateEmployeeTrainingRecordRequestCost Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateEmployeeTrainingRecordRequestCost implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_employee_training_record_request_cost';
	...
	*/
	 ...
	 * Sets amount
	 *
	 * @param string|null $amount Monetary amount as a decimal string (e.g. '100.00').
	 *
	 * @return self
	 */
