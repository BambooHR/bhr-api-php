...
/**
 * TimeOffTabViewModelTransformer Class Doc Comment
 *
 * @category Class
 ...
 */
class TimeOffTabViewModelTransformer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeOffTabViewModelTransformer';
    ...
    protected static $openAPITypes = [
        ...
        'pto_session' => '\MySdk\Model\TimeOffSessionViewModelTransformer',
        'pto_date' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pto_session', $data ?? [], null);
        $this->setIfExists('pto_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets pto_session
     *
     * @return \MySdk\Model\TimeOffSessionViewModelTransformer|null
     */
    public function getPtoSession()
    {
        return $this->container['pto_session'];
    }
     ...
     * @return self
     */
    public function setPtoSession($pto_session)
    {
        if (is_null($pto_session)) {
            throw new \InvalidArgumentException('non-nullable pto_session cannot be null');
        }
        $this->container['pto_session'] = $pto_session;
     ...
     * @return string|null
     */
    public function getPtoDate()
    {
        return $this->container['pto_date'];
    }

    /**
     * Sets pto_date
     *
     * @param string|null $pto_date pto_date
     *
     * @return self
     */
    public function setPtoDate($pto_date)
    {
        if (is_null($pto_date)) {
            throw new \InvalidArgumentException('non-nullable pto_date cannot be null');
        }
        $this->container['pto_date'] = $pto_date;
