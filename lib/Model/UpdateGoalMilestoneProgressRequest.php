...
/**
 * UpdateGoalMilestoneProgressRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateGoalMilestoneProgressRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_goal_milestone_progress_request';
	...
	*/
	 ...
	 * Sets complete
	 *
	 * @param bool $complete Whether the milestone is complete or not
	 *
	 * @return self
	 */
