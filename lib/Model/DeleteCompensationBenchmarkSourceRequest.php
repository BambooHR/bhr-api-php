...
/**
 * DeleteCompensationBenchmarkSourceRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class DeleteCompensationBenchmarkSourceRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'DeleteCompensationBenchmarkSourceRequest';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string $id ID of the benchmark source to delete. Must be non-empty.
	 *
	 * @return self
	 */
