...
/**
 * CompensationEquitySettingsResponseSliderMin Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationEquitySettingsResponseSliderMin implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationEquitySettingsResponse_sliderMin';
