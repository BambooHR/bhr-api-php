...
/**
 * TimeOffPolicy Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class TimeOffPolicy implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeOffPolicy';
	...
	public const TYPE_ACCRUING = 'accruing';
	public const TYPE_DISCRETIONARY = 'discretionary';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id The policy ID.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param int|null $time_off_type_id The ID of the time off type this policy belongs to.
	 *
	 * @return self
	 */
	...
	public function setEffectiveDate($effective_date) {
		if (is_null($effective_date)) {
			$this->openApiNullablesSetToNull['effective_date'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['effective_date'])) {
				unset($nullablesSetToNull['effective_date']);
