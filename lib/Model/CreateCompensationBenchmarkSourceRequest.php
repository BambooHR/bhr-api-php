...
/**
 * CreateCompensationBenchmarkSourceRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCompensationBenchmarkSourceRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CreateCompensationBenchmarkSourceRequest';
	...
	*/
	 ...
	 * Sets name
	 *
	 * @param string $name Display name for the new benchmark source. Cannot be empty or equal to `mercer`.
	 *
	 * @return self
	 */
	 ...
	 * Sets color_code
	 *
	 * @param string|null $color_code Optional hex color used to display the source in the UI.
	 *
	 * @return self
	 */
