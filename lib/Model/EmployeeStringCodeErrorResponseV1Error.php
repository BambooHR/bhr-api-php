...
/**
 * EmployeeStringCodeErrorResponseV1Error Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeStringCodeErrorResponseV1Error implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Employee_StringCodeErrorResponse_V1_error';
	...
	*/
	 ...
	 * Sets code
	 *
	 * @param string $code String error code identifier (for example `BadRequest` or `BadPage`).
	 *
	 * @return self
	 */
