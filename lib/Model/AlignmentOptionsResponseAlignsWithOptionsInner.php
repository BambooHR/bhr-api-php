...
/**
 * AlignmentOptionsResponseAlignsWithOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class AlignmentOptionsResponseAlignsWithOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'AlignmentOptionsResponse_alignsWithOptions_inner';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id The goal ID.
	 *
	 * @return self
	 */
	 ...
	 * Sets title
	 *
	 * @param string|null $title The display title of the goal.
	 *
	 * @return self
	 */
