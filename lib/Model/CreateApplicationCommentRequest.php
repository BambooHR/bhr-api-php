...
/**
 * CreateApplicationCommentRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateApplicationCommentRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_application_comment_request';
	...
	*/
	 ...
	 * Sets type
	 *
	 * @param string|null $type The comment type. Defaults to `comment` if omitted.
	 *
	 * @return self
	 */
	 ...
	 * Sets comment
	 *
	 * @param string $comment The comment being posted.
	 *
	 * @return self
	 */
