...
/**
 * EnrollmentWindowCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class EnrollmentWindowCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnrollmentWindowCreateRequest';
    ...
    protected static array $openAPINullables = [
        ...
        'employee_ids' => false,
        'type' => false,
        'qualifying_life_event_subtype_id' => true,
        'plan_year_id' => false,
        'date_of_event' => true
    ];
    ...
    */
     ...
     *
     * @param \DateTime|null $benefit_effective_date benefit_effective_date
     *
     * @return self
     */
    ...
    public function setQualifyingLifeEventSubtypeId($qualifying_life_event_subtype_id)
    {
        if (is_null($qualifying_life_event_subtype_id)) {
            array_push($this->openAPINullablesSetToNull, 'qualifying_life_event_subtype_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('qualifying_life_event_subtype_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets date_of_event
     *
     * @param \DateTime|null $date_of_event date_of_event
     *
     * @return self
     */
    public function setDateOfEvent($date_of_event)
    {
        if (is_null($date_of_event)) {
            array_push($this->openAPINullablesSetToNull, 'date_of_event');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('date_of_event', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
