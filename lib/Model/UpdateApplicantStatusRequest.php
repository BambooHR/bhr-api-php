...
/**
 * UpdateApplicantStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateApplicantStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_applicant_status_request';
	...
	*/
	 ...
	 * Sets status
	 *
	 * @param int $status The ID of the status to assign to the application. Use the Get Applicant Statuses endpoint to get available status IDs.
	 *
	 * @return self
	 */
