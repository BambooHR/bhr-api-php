...
/**
 * CreateFullAdminEmployeeRequestObject Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateFullAdminEmployeeRequestObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFullAdminEmployeeRequestObject';
    ...
    */
     ...
     * Sets work_email
     *
     * @param string $work_email Work email of the employee
     *
     * @return self
     */
     ...
     * Sets work_phone
     *
     * @param string $work_phone Work phone number of the employee
     *
     * @return self
     */
