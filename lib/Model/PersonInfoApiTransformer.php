...
/**
 * PersonInfoApiTransformer Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class PersonInfoApiTransformer implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'PersonInfoApiTransformer';
	...
	*/
	 ...
	 *
	 * @param string|null $display_first_name Display first name
	 *
	 * @return self
	 */
