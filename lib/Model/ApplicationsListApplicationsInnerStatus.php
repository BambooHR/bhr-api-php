...
/**
 * ApplicationsListApplicationsInnerStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationsListApplicationsInnerStatus implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ApplicationsList_applications_inner_status';
