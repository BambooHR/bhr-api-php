...
/**
 * GetCustomerOnboardingContact Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class GetCustomerOnboardingContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCustomerOnboardingContact';
    ...
    */
     ...
     * Sets user_id
     *
     * @param int|null $user_id Unique identifier for the contact user
     *
     * @return self
     */
     ...
     * Sets work_email
     *
     * @param string|null $work_email Work email address of the contact
     *
     * @return self
     */
     ...
     * Sets work_phone
     *
     * @param string|null $work_phone Work phone number of the contact
     *
     * @return self
     */
     ...
     * Sets photo_url
     *
     * @param string|null $photo_url URL to the contact's profile photo
     *
     * @return self
     */
