...
/**
 * UpdateApplicantStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateApplicantStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'UpdateApplicantStatusResponse';
	...
	*/
	 ...
	 * Sets type
	 *
	 * @param string|null $type Always 'positionApplicantStatus'
	 *
	 * @return self
	 */
	 ...
	 * Sets id
	 *
	 * @param int|null $id The ID of the created status change record
	 *
	 * @return self
	 */
