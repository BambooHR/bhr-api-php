...
/**
 * WebhookSubErrorPropertyUnknownFieldsInnerId Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class WebhookSubErrorPropertyUnknownFieldsInnerId implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'WebhookSubErrorProperty_unknownFields_inner_id';
