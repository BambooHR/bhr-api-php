 ...
 */
class PlanYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlanYear';
    ...
    */
     ...
     * Sets plan_ids
     *
     * @param object[]|null $plan_ids plan_ids
     *
     * @return self
     */
    ...
    /**
     * Gets open_enrollments
     *
     * @return \MySdk\Model\BenefitEnrollmentWindowResponse|null
     */
    public function getOpenEnrollments()
    {
        return $this->container['open_enrollments'];
    }

    /**
     * Sets open_enrollments
     *
     * @param \MySdk\Model\BenefitEnrollmentWindowResponse|null $open_enrollments open_enrollments
     *
     * @return self
     */
    public function setOpenEnrollments($open_enrollments)
    {
        if (is_null($open_enrollments)) {
            throw new \InvalidArgumentException('non-nullable open_enrollments cannot be null');
        }
        $this->container['open_enrollments'] = $open_enrollments;
     ...
     * Gets new_hire_rule
     *
     * @return \MySdk\Model\NewHireAutomationSettingLike|null
     */
    public function getNewHireRule()
    {
        return $this->container['new_hire_rule'];
    }

    /**
     * Sets new_hire_rule
     *
     * @param \MySdk\Model\NewHireAutomationSettingLike|null $new_hire_rule new_hire_rule
     *
     * @return self
     */
    public function setNewHireRule($new_hire_rule)
    {
        if (is_null($new_hire_rule)) {
