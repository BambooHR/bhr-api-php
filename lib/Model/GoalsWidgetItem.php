...
/**
 * GoalsWidgetItem Class Doc Comment
 *
 * @category Class
 ...
 */
class GoalsWidgetItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GoalsWidgetItem';
    ...
    */
     ...
     * Sets due
     *
     * @param \DateTime|null $due Goal due date in ISO 8601 format
     *
     * @return self
     */
     ...
     * Sets percent
     *
     * @param int|null $percent Percentage of goal completion
     *
     * @return self
     */
    public function setPercent($percent)
    {
        ...
        if (($percent > 100)) {
            throw new \InvalidArgumentException('invalid value for $percent when calling GoalsWidgetItem., must be smaller than or equal to 100.');
        }
        if (($percent < 0)) {
            throw new \InvalidArgumentException('invalid value for $percent when calling GoalsWidgetItem., must be bigger than or equal to 0.');
        }
