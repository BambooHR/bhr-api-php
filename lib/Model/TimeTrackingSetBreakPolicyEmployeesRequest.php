...
/**
 * TimeTrackingSetBreakPolicyEmployeesRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class TimeTrackingSetBreakPolicyEmployeesRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'time_tracking_set_break_policy_employees_request';
