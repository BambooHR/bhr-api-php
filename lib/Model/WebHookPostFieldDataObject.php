...
class WebHookPostFieldDataObject implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	*/
	...
	public function setType($type) {
		if (is_null($type)) {
			$this->openApiNullablesSetToNull['type'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['type'])) {
				unset($nullablesSetToNull['type']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
	 ...
	 * Sets id
	 *
	 * @param int $id Field ID. This may be a standard/custom field ID or a synthetic negative ID for calculated fields.
	 *
	 * @return self
	 */
	 ...
	 * Sets page_id
	 *
	 * @param int $page_id ID of the page the field belongs to. Calculated fields may use `-1`. Fields without a usable page ID are not available in webhooks.
	 *
	 * @return self
	 */
	...
	public function setTableId($table_id) {
		if (is_null($table_id)) {
			$this->openApiNullablesSetToNull['table_id'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['table_id'])) {
				unset($nullablesSetToNull['table_id']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
