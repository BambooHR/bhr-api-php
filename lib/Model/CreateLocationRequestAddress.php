...
/**
 * CreateLocationRequestAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateLocationRequestAddress implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_location_request_address';
	...
	*/
	...
	public function setRemoteLocation($remote_location) {
		if (is_null($remote_location)) {
			$this->openApiNullablesSetToNull['remote_location'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['remote_location'])) {
				unset($nullablesSetToNull['remote_location']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
