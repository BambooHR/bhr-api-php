...
/**
 * MemberBenefitsGetPermissionDeniedResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class MemberBenefitsGetPermissionDeniedResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'MemberBenefitsGetPermissionDeniedResponse';
