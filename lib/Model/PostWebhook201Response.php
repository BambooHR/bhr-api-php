 ...
 */
class PostWebhook201Response implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'post_webhook_201_response';
	...
	*/
	 ...
	 * Sets private_key
	 *
	 * @param string|null $private_key The private key which can be used to verify that the webhook is secure (uses HMAC-SHA256)
	 *
	 * @return self
	 */
