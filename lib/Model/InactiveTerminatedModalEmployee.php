<?php
/**
 * InactiveTerminatedModalEmployee
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InactiveTerminatedModalEmployee Class Doc Comment
 *
 * @category Class
 ...
 */
class InactiveTerminatedModalEmployee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InactiveTerminatedModal_employee';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Employee identifier
     *
     * @return self
     */
     ...
     * Sets preferred_name
     *
     * @param string|null $preferred_name Employee preferred name if available
     *
     * @return self
     */
