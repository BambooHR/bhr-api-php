<?php
/**
 * PayrollPrePayrollHoursShiftDifferentialDataItemValue
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PayrollPrePayrollHoursShiftDifferentialDataItemValue Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayrollPrePayrollHoursShiftDifferentialDataItemValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payroll_PrePayrollHours_ShiftDifferentialDataItem_value';
    ...
    */
     ...
     *
     * @param int|null $shift_differential_id Unique identifier for the shift differential
     *
     * @return self
     */
     ...
     *
     * @param string|null $shift_differential_name Display name of the shift differential
     *
     * @return self
     */
