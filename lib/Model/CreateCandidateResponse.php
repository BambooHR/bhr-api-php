...
/**
 * CreateCandidateResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCandidateResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CreateCandidateResponse';
	...
	*/
	 ...
	 * Sets candidate_id
	 *
	 * @param int|null $candidate_id The ID of the newly created candidate
	 *
	 * @return self
	 */
