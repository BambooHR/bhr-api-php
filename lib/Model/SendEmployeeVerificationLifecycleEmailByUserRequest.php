...
/**
 * SendEmployeeVerificationLifecycleEmailByUserRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SendEmployeeVerificationLifecycleEmailByUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'send_employee_verification_lifecycle_email_by_user_request';
	...
	public const EMAIL_TYPE_SIGNUP_SURVEY = 'signup_survey';
	public const EMAIL_TYPE_APP_INSTALLED = 'app_installed';
	...
	public function getEmailTypeAllowableValues() {
		return [
			self::EMAIL_TYPE_SIGNUP_SURVEY,
			self::EMAIL_TYPE_APP_INSTALLED,
		];
	}
	...
	*/
	 ...
	 * Sets email_type
	 *
	 * @param string $email_type Which employee verification lifecycle email to send; must be {@see EverifyEmailType::SIGNUP_SURVEY} or {@see EverifyEmailType::APP_INSTALLED} (string values `signup_survey`, `app_installed`).
	 *
	 * @return self
	 */
