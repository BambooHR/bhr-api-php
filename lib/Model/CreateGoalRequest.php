...
/**
 * CreateGoalRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateGoalRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_goal_request';
	...
	protected static $openApiTypes = [
		...
		'milestones' => '\BhrSdk\Model\CreateGoalRequestMilestonesInner[]'
	];
	...
	*/
	 ...
	 *
	 * @param int|null $percent_complete Initial percentage of completion for a simple goal (0-100). Defaults to 0 if omitted. Ignored when `milestones` is provided; milestone-based goals derive percent complete from milestone completion and should be updated via `update-goal-milestone-progress`.
	 *
	 * @return self
	 */
	public function setPercentComplete($percent_complete) {
		...
		if (($percent_complete > 100)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling CreateGoalRequest., must be smaller than or equal to 100.');
		}
		if (($percent_complete < 0)) {
			throw new \InvalidArgumentException('invalid value for $percent_complete when calling CreateGoalRequest., must be bigger than or equal to 0.');
		}
	 ...
	 * Gets milestones
	 *
	 * @return \BhrSdk\Model\CreateGoalRequestMilestonesInner[]|null
	 */
	 ...
	 * Sets milestones
	 *
	 * @param \BhrSdk\Model\CreateGoalRequestMilestonesInner[]|null $milestones Optional. Provide a non-empty array of milestone objects to create a milestone-based goal. Omit this field (or send `null`) to create a simple goal.
	 *
	 * @return self
	 */
