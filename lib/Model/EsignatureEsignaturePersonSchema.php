<?php
/**
 * EsignatureEsignaturePersonSchema
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * EsignatureEsignaturePersonSchema Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class EsignatureEsignaturePersonSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Esignature-EsignaturePersonSchema';
    ...
    */
     ...
     * Sets preferred_name
     *
     * @param string|null $preferred_name Preferred name of the person
     *
     * @return self
     */
     ...
     * Sets photo_url
     *
     * @param string|null $photo_url URL of the person's photo
     *
     * @return self
     */
