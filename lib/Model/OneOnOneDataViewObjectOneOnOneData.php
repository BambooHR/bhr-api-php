<?php
/**
 * OneOnOneDataViewObjectOneOnOneData
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * OneOnOneDataViewObjectOneOnOneData Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class OneOnOneDataViewObjectOneOnOneData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OneOnOneDataViewObject_oneOnOneData';
    ...
    protected static $openAPITypes = [
        ...
        'frequency' => 'string',
        'current' => '\MySdk\Model\OneOnOneRecordViewObject',
        'previous' => '\MySdk\Model\OneOnOneRecordViewObject'
    ];
    ...
    {
        $this->setIfExists('blank_state', $data ?? [], null);
        $this->setIfExists('employee_first_name', $data ?? [], null);
        $this->setIfExists('manager_first_name', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getBlankState()
    {
        return $this->container['blank_state'];
    }

    /**
     * Sets blank_state
     *
     * @param string|null $blank_state blank_state
     *
     * @return self
     */
    public function setBlankState($blank_state)
    {
        if (is_null($blank_state)) {
            throw new \InvalidArgumentException('non-nullable blank_state cannot be null');
        }
        $this->container['blank_state'] = $blank_state;
     ...
     *
     * @param string|null $manager_first_name manager_first_name
     *
     * @return self
     */
    public function setManagerFirstName($manager_first_name)
    {
        if (is_null($manager_first_name)) {
            throw new \InvalidArgumentException('non-nullable manager_first_name cannot be null');
        }
     ...
     * Gets current
     *
     * @return \MySdk\Model\OneOnOneRecordViewObject|null
     */
     ...
     * Sets current
     *
     * @param \MySdk\Model\OneOnOneRecordViewObject|null $current current
     *
     * @return self
     */
     ...
     * Sets previous
     *
     * @param \MySdk\Model\OneOnOneRecordViewObject|null $previous previous
     *
     * @return self
     */
