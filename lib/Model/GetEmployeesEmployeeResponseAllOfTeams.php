...
/**
 * GetEmployeesEmployeeResponseAllOfTeams Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class GetEmployeesEmployeeResponseAllOfTeams implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'GetEmployeesEmployeeResponse_allOf_teams';
