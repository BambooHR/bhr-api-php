...
/**
 * AvailableAction Class Doc Comment
 *
 * @category Class
 ...
 */
class AvailableAction implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'AvailableAction';
	...
	*/
	 ...
	 * Sets href
	 *
	 * @param string|null $href The URL for this action
	 *
	 * @return self
	 */
	...
	public function setFields($fields) {
		if (is_null($fields)) {
			$this->openApiNullablesSetToNull['fields'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['fields'])) {
				unset($nullablesSetToNull['fields']);
