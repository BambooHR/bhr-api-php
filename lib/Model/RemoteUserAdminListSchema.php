...
/**
 * RemoteUserAdminListSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class RemoteUserAdminListSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoteUserAdminListSchema';
    ...
    protected static $openAPITypes = [
        'account_owner' => '\MySdk\Model\RemoteUserListViewSchema',
        'admin_users' => '\MySdk\Model\RemoteUserListViewSchema[]'
    ];
    ...
    */
     ...
     * Gets account_owner
     *
     * @return \MySdk\Model\RemoteUserListViewSchema|null
     */
     ...
     * Sets account_owner
     *
     * @param \MySdk\Model\RemoteUserListViewSchema|null $account_owner The Remote account owner
     *
     * @return self
     */
     ...
     * Sets admin_users
     *
     * @param \MySdk\Model\RemoteUserListViewSchema[]|null $admin_users A collection of remote user list view data objects
     *
     * @return self
     */
    public function setAdminUsers($admin_users)
    {
        if (is_null($admin_users)) {
            throw new \InvalidArgumentException('non-nullable admin_users cannot be null');
        }
