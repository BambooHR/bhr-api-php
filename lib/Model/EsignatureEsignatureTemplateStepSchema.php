<?php
/**
 * EsignatureEsignatureTemplateStepSchema
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * EsignatureEsignatureTemplateStepSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class EsignatureEsignatureTemplateStepSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Esignature-EsignatureTemplateStepSchema';
    ...
    protected static $openAPITypes = [
        ...
        'fields' => '\MySdk\Model\EsignatureEsignatureTemplateFieldSchema[]'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for the template step.
     *
     * @return self
     */
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order Order in which the step appears in the template.
     *
     * @return self
     */
     ...
     * Sets assigned_to
     *
     * @param string|null $assigned_to Name or role of the person to whom the step is assigned.
     *
     * @return self
     */
     ...
     *
     * @param int|null $assigned_user_id Identifier for the user to whom the step is assigned, if applicable.
     *
     * @return self
     */
     ...
     * Gets fields
     *
     * @return \MySdk\Model\EsignatureEsignatureTemplateFieldSchema[]|null
     */
     ...
     * Sets fields
     *
     * @param \MySdk\Model\EsignatureEsignatureTemplateFieldSchema[]|null $fields List of fields associated with this step, if any.
     *
     * @return self
     */
