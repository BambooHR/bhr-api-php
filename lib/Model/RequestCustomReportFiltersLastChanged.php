 ...
 */
class RequestCustomReportFiltersLastChanged implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'RequestCustomReport_filters_lastChanged';
	...
	*/
	...
	public function getIncludeNull() {
		return $this->container['include_null'];
	}
	 ...
	 * @return self
	 */
	public function setIncludeNull($include_null) {
