...
/**
 * FileSummaryDataObject Class Doc Comment
 *
 * @category Class
 ...
 */
class FileSummaryDataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileSummaryDataObject';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique identifier of the file
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The creation date of the file
     *
     * @return self
     */
     ...
     * Sets created_user
     *
     * @param string|null $created_user The user who created the file
     *
     * @return self
     */
    public function setCreatedUser($created_user)
    {
        if (is_null($created_user)) {
            array_push($this->openAPINullablesSetToNull, 'created_user');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('created_user', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int|null $most_recent_file_data_id The ID of the most recent file data
     *
     * @return self
     */
    public function setMostRecentFileDataId($most_recent_file_data_id)
    {
        if (is_null($most_recent_file_data_id)) {
            array_push($this->openAPINullablesSetToNull, 'most_recent_file_data_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('most_recent_file_data_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_shared
     *
     * @param bool|null $is_shared Indicates if the file is shared
     *
     * @return self
     */
     ...
     * Sets file_on_s3
     *
     * @param bool|null $file_on_s3 Indicates if the file is stored on S3
     *
     * @return self
     */
     ...
     * Sets scan_complete
     *
     * @param bool|null $scan_complete Indicates if the file scan is complete
     *
     * @return self
     */
     ...
     * Sets preview
     *
     * @param string|null $preview The preview status of the file
     *
     * @return self
     */
