...
/**
 * CreateTrainingTypeRequestCategory Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTrainingTypeRequestCategory implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'create_training_type_request_category';
