...
/**
 * UpdatedHoursResponseInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdatedHoursResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatedHoursResponse_inner';
    ...
    */
     ...
     * Sets hours
     *
     * @param array<string,float>|null $hours Hours data for the employee with hour types as keys and hour values
     *
     * @return self
     */
