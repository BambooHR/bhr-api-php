...
/**
 * ApplicationDetailsJobTitle Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationDetailsJobTitle implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ApplicationDetails_job_title';
