<?php
/**
 * DetailedPaycheckTransformerCompensation
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DetailedPaycheckTransformerCompensation Class Doc Comment
 *
 * @category Class
 ...
 */
class DetailedPaycheckTransformerCompensation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DetailedPaycheckTransformer_compensation';
    ...
    */
     ...
     * Sets wage_type
     *
     * @param string|null $wage_type The wage type for the employee
     *
     * @return self
     */
     ...
     *
     * @param float|null $base_compensation Base compensation amount
     *
     * @return self
     */
     ...
     * Sets default_hours
     *
     * @param float|null $default_hours Default hours for the employee
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_overtime_exempt Flag indicating if employee is exempt from overtime
     *
     * @return self
     */
