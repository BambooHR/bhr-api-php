...
/**
 * UpdateWebhookBadRequestResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateWebhookBadRequestResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'UpdateWebhookBadRequestResponse';
