 ...
 */
class TimeTrackingBulkResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeTrackingBulkResponseSchema';
