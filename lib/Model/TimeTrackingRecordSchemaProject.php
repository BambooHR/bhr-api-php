 ...
 */
class TimeTrackingRecordSchemaProject implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TimeTrackingRecordSchema_project';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param int|null $id Project information
	 *
	 * @return self
	 */
