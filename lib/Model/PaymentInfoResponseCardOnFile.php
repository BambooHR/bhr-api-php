...
/**
 * PaymentInfoResponseCardOnFile Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PaymentInfoResponseCardOnFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInfoResponse_cardOnFile';
    ...
    protected static $openAPIFormats = [
        'card_expiration_date' => 'date-time'
    ];
    ...
    */
     ...
     *
     * @param \DateTime|null $card_expiration_date card_expiration_date
     *
     * @return self
     */
    public function setCardExpirationDate($card_expiration_date)
    {
        if (is_null($card_expiration_date)) {
            throw new \InvalidArgumentException('non-nullable card_expiration_date cannot be null');
        }
