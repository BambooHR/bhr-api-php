...
class TimeOffBalanceEntry implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	*/
	 ...
	 * Sets balance
	 *
	 * @param string|null $balance The calculated time off balance as of the specified date, rounded using `precision`.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param string|null $used_year_to_date The amount of time off used year-to-date as of the specified date, rounded using `precision`.
	 *
	 * @return self
	 */
