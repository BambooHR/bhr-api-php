...
/**
 * GlobalWebhookDataObject Class Doc Comment
 *
 * @category Class
 ...
 */
class GlobalWebhookDataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GlobalWebhookDataObject';
    ...
    */
     ...
     * Sets private_key
     *
     * @param string|null $private_key Private key for webhook authentication (masked)
     *
     * @return self
     */
     ...
     * Sets format
     *
     * @param string|null $format Format of the webhook payload
     *
     * @return self
     */
     ...
     * Sets monitor_fields
     *
     * @param int[]|null $monitor_fields Fields to monitor for changes
     *
     * @return self
     */
     ...
     * Sets post_fields
     *
     * @param \MySdk\Model\WebhookSelectedPostFieldDataObject[]|null $post_fields Fields to include in the webhook payload
     *
     * @return self
     */
