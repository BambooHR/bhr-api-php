...
/**
 * CompensationBenchmarkSource Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationBenchmarkSource implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationBenchmarkSource';
	...
	*/
	 ...
	 * Sets sort
	 *
	 * @param string|null $sort Sort order position, returned as a numeric string.
	 *
	 * @return self
	 */
	 ...
	 * Sets count
	 *
	 * @param string|null $count Number of benchmarks attached to this source, returned as a numeric string.
	 *
	 * @return self
	 */
	 ...
	 * Sets color_code
	 *
	 * @param string|null $color_code color_code
	 *
	 * @return self
	 */
	public function setColorCode($color_code) {
		if (is_null($color_code)) {
			$this->openApiNullablesSetToNull['color_code'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['color_code'])) {
				unset($nullablesSetToNull['color_code']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
