...
/**
 * CompanyProfileIntegrations Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompanyProfileIntegrations implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompanyProfileIntegrations';
	...
	*/
	 ...
	 * Sets integrations
	 *
	 * @param string[]|null $integrations List of installed integration identifiers.
	 *
	 * @return self
	 */
