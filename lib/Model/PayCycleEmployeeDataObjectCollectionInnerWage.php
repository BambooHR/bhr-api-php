<?php
/**
 * PayCycleEmployeeDataObjectCollectionInnerWage
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PayCycleEmployeeDataObjectCollectionInnerWage Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayCycleEmployeeDataObjectCollectionInnerWage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayCycleEmployeeDataObjectCollection_inner_wage';
    ...
    protected static $attributeMap = [
        'overtime_is_exempt' => 'overtimeIsExempt',
        'wage_type' => 'wageType',
    ...
    protected static $setters = [
        'overtime_is_exempt' => 'setOvertimeIsExempt',
    ...
    protected static $getters = [
        'overtime_is_exempt' => 'getOvertimeIsExempt',
    ...
    {
        $this->setIfExists('overtime_is_exempt', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets overtime_is_exempt
     *
     * @return bool|null
     */
    public function getOvertimeIsExempt()
    {
        return $this->container['overtime_is_exempt'];
    }

    /**
     * Sets overtime_is_exempt
     *
     * @param bool|null $overtime_is_exempt overtime_is_exempt
     *
     * @return self
     */
    public function setOvertimeIsExempt($overtime_is_exempt)
    {
        if (is_null($overtime_is_exempt)) {
            throw new \InvalidArgumentException('non-nullable overtime_is_exempt cannot be null');
        }
        $this->container['overtime_is_exempt'] = $overtime_is_exempt;
     ...
     *
     * @param float|null $base_compensation base_compensation
     *
     * @return self
     */
    public function setBaseCompensation($base_compensation)
    {
        if (is_null($base_compensation)) {
            throw new \InvalidArgumentException('non-nullable base_compensation cannot be null');
        }
     ...
     * Sets default_hours
     *
     * @param float|null $default_hours default_hours
     *
     * @return self
     */
