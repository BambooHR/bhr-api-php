...
/**
 * ApplicationsListApplicationsInnerApplicant Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationsListApplicationsInnerApplicant implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ApplicationsList_applications_inner_applicant';
