...
/**
 * GetGoalsAggregateV12200ResponseCommentsInner Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class GetGoalsAggregateV12200ResponseCommentsInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'get_goals_aggregate_v1_2_200_response_comments_inner';
	...
	*/
	 ...
	 * Sets comment_count
	 *
	 * @param int|null $comment_count How many comments are linked to the goal
	 *
	 * @return self
	 */
