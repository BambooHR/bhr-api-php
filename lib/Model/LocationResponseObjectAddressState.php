...
/**
 * LocationResponseObjectAddressState Class Doc Comment
 *
 * @category Class
 ...
 */
class LocationResponseObjectAddressState implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'LocationResponseObject_address_state';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id State identifier
	 *
	 * @return self
	 */
	 ...
	 * Sets abbreviation
	 *
	 * @param string|null $abbreviation State abbreviation
	 *
	 * @return self
	 */
