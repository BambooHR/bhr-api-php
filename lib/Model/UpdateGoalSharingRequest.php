...
/**
 * UpdateGoalSharingRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateGoalSharingRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'update_goal_sharing_request';
	...
	*/
	 ...
	 *
	 * @param int[]|null $shared_with_employee_ids List of employee IDs with whom the goal is shared. Must include the employee ID of the goal owner.
	 *
	 * @return self
	 */
