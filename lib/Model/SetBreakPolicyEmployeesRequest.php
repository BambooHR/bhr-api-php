...
/**
 * SetBreakPolicyEmployeesRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SetBreakPolicyEmployeesRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'set_break_policy_employees_request';
	...
	*/
	 ...
	 * Sets employee_ids
	 *
	 * @param int[] $employee_ids Array of employee IDs to assign to the break policy. Replaces all existing assignments.
	 *
	 * @return self
	 */
