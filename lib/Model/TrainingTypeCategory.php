...
/**
 * TrainingTypeCategory Class Doc Comment
 *
 * @category Class
 ...
 */
class TrainingTypeCategory implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TrainingType_category';
