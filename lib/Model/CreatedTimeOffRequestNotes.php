...
/**
 * CreatedTimeOffRequestNotes Class Doc Comment
 *
 * @category Class
 * @description Notes from employee and/or manager. The object is always present; the &#x60;employee&#x60; and &#x60;manager&#x60; keys are each included only when a non-empty note was provided.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreatedTimeOffRequestNotes implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CreatedTimeOffRequest_notes';
	...
	*/
	 ...
	 * Sets employee
	 *
	 * @param string|null $employee Note from the employee.
	 *
	 * @return self
	 */
	 ...
	 * Sets manager
	 *
	 * @param string|null $manager Note from the manager.
	 *
	 * @return self
	 */
