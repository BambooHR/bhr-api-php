<?php
/**
 * CommonDataObjectsPayrollPayrollTaxStateUiSelectOption
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CommonDataObjectsPayrollPayrollTaxStateUiSelectOption Class Doc Comment
 *
 * @category Class
 ...
 */
class CommonDataObjectsPayrollPayrollTaxStateUiSelectOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Common-DataObjects-Payroll-PayrollTaxStateUiSelectOption';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for the option
     *
     * @return self
     */
