...
/**
 * EmployeeDataTimeOffAvailableDataObject Class Doc Comment
 *
 * @category Class
 ...
 */
class EmployeeDataTimeOffAvailableDataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeDataTimeOffAvailableDataObject';
    ...
    */
     ...
     * Sets is_unlimited
     *
     * @param bool|null $is_unlimited Indicates if the time off available is unlimited
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of time off available (e.g., Vacation, PTO)
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit The unit of time off available (e.g., hours, days)
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance The balance of time off available
     *
     * @return self
     */
