...
/**
 * PayGradesAndBandsSaveLevelsResponse Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class PayGradesAndBandsSaveLevelsResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'PayGradesAndBandsSaveLevelsResponse';
