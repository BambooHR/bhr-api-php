...
/**
 * TaskCreateSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class TaskCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TaskCreateSchema';
	...
	*/
	 ...
	 * Sets billable
	 *
	 * @param bool|null $billable Indicates if the task is billable. Defaults to true if not provided.
	 *
	 * @return self
	 */
