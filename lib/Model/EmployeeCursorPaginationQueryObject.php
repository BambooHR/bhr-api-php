...
/**
 * EmployeeCursorPaginationQueryObject Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeCursorPaginationQueryObject implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'EmployeeCursorPaginationQueryObject';
	...
	public function __construct(?array $data = null) {
		...
		$this->setIfExists('limit', $data ?? [], 250);
	}
	...
	*/
	...
	public function listInvalidProperties() {
		...
		if (!is_null($this->container['limit']) && ($this->container['limit'] > 2500)) {
			$invalidProperties[] = "invalid value for 'limit', must be smaller than or equal to 2500.";
		}
	 ...
	 * Sets limit
	 *
	 * @param int|null $limit Maximum number of items to return. This can be at most 2500.
	 *
	 * @return self
	 */
	public function setLimit($limit) {
		...
		if (($limit > 2500)) {
			throw new \InvalidArgumentException('invalid value for $limit when calling EmployeeCursorPaginationQueryObject., must be smaller than or equal to 2500.');
		}
		if (($limit < 1)) {
			throw new \InvalidArgumentException('invalid value for $limit when calling EmployeeCursorPaginationQueryObject., must be bigger than or equal to 1.');
		}
