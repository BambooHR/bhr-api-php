...
/**
 * ApplicationsListApplicationsItemsInnerApplicant Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationsListApplicationsItemsInnerApplicant implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'ApplicationsList_applications_items_inner_applicant';
