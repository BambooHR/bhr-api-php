...
/**
 * GetBreakPolicySuggestionsRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class GetBreakPolicySuggestionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'get_break_policy_suggestions_request';
	...
	*/
	 ...
	 * Sets prompt
	 *
	 * @param string $prompt The user's request or question for break policy suggestions (e.g. \"What policies do we need for our California employees?\")
	 *
	 * @return self
	 */
	public function setPrompt($prompt) {
		...
		if ((mb_strlen($prompt) < 1)) {
			throw new \InvalidArgumentException('invalid length for $prompt when calling GetBreakPolicySuggestionsRequest., must be bigger than or equal to 1.');
		}
