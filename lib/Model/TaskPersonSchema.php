...
/**
 * TaskPersonSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class TaskPersonSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Task-PersonSchema';
    ...
    */
     ...
     * Sets employee_id
     *
     * @param int|null $employee_id The employee ID of the user, if applicable. Null for non-employee users.
     *
     * @return self
     */
     ...
     * Sets photo_url
     *
     * @param string|null $photo_url The URL of the user's photo.
     *
     * @return self
     */
