...
class LoginResponse implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	*/
	 ...
	 * Sets success
	 *
	 * @param bool $success Always `true` on HTTP 200.
	 *
	 * @return self
	 */
	 ...
	 * Sets key
	 *
	 * @param string $key The API key to use for subsequent requests.
	 *
	 * @return self
	 */
	 ...
	 * Sets api_url
	 *
	 * @param string $api_url The base URL for subsequent API calls.
	 *
	 * @return self
	 */
