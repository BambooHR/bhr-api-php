...
/**
 * CreatedTimeOffRequestStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatedTimeOffRequestStatus implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CreatedTimeOffRequest_status';
	...
	public function __construct(?array $data = null) {
		...
		$this->setIfExists('last_changed_by_user_id', $data ?? [], null);
	}
	...
	*/
	 ...
	 * Sets status
	 *
	 * @param string|null $status The current status value (e.g. `approved`, `denied`, `requested`).
	 *
	 * @return self
	 */
	 ...
	 * Sets last_changed
	 *
	 * @param string|null $last_changed The date and time the status was last changed, formatted as `YYYY-MM-DD HH:MM:SS` in the company timezone.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param int|null $last_changed_by_user_id The user ID who last changed the status.
	 *
	 * @return self
	 */
	public function setLastChangedByUserId($last_changed_by_user_id) {
		if (is_null($last_changed_by_user_id)) {
			throw new \InvalidArgumentException('non-nullable last_changed_by_user_id cannot be null');
		}
