...
/**
 * TotalRewardsCompSummaryValues Class Doc Comment
 *
 * @category Class
 ...
 */
class TotalRewardsCompSummaryValues implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'TotalRewards-CompSummaryValues';
	...
	*/
	...
	public function setSubtitle($subtitle) {
		if (is_null($subtitle)) {
			$this->openApiNullablesSetToNull['subtitle'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['subtitle'])) {
				unset($nullablesSetToNull['subtitle']);
