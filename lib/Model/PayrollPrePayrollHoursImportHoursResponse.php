...
/**
 * PayrollPrePayrollHoursImportHoursResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PayrollPrePayrollHoursImportHoursResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payroll-PrePayrollHours-ImportHoursResponse';
    ...
    protected static $openAPITypes = [
        'manager_data' => 'array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseManagerDataValue>',
        ...
        'data' => 'array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseDataValue>'
    ];
    ...
    {
        $this->setIfExists('manager_data', $data ?? [], null);
    ...
    */
     ...
     * Gets manager_data
     *
     * @return array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseManagerDataValue>|null
     */
    public function getManagerData()
    {
        return $this->container['manager_data'];
    }

    /**
     * Sets manager_data
     *
     * @param array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseManagerDataValue>|null $manager_data Manager data keyed by employee ID
     *
     * @return self
     */
    public function setManagerData($manager_data)
    {
        if (is_null($manager_data)) {
            throw new \InvalidArgumentException('non-nullable manager_data cannot be null');
        }
        $this->container['manager_data'] = $manager_data;
     ...
     * Gets data
     *
     * @return array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseDataValue>|null
     */
     ...
     * Sets data
     *
     * @param array<string,\MySdk\Model\PayrollPrePayrollHoursImportHoursResponseDataValue>|null $data Employee hours data keyed by employee ID
     *
     * @return self
     */
