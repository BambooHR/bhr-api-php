...
/**
 * EmailTemplateSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailTemplateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailTemplateSchema';
    ...
    */
     ...
     *
     * @param int|null $wysiwyg_version Sort order of the email template
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Expanded message content
     *
     * @return self
     */
