...
/**
 * BenefitCoveragesResponseBenefitCoveragesInner Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class BenefitCoveragesResponseBenefitCoveragesInner implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'BenefitCoveragesResponse_Benefit_Coverages_inner';
	...
	*/
	 ...
	 * Sets id
	 *
	 * @param string|null $id The coverage level ID.
	 *
	 * @return self
	 */
	 ...
	 * Sets short_name
	 *
	 * @param string|null $short_name The short display name for this coverage level (e.g. \"Employee + Spouse\").
	 *
	 * @return self
	 */
	 ...
	 * Sets sort_order
	 *
	 * @param string|null $sort_order The display sort order for this coverage level.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @param string|null $benefit_plan_id benefit_plan_id
	 *
	 * @return self
	 */
	public function setBenefitPlanId($benefit_plan_id) {
		if (is_null($benefit_plan_id)) {
			$this->openApiNullablesSetToNull['benefit_plan_id'] = true;
		} else {
			$nullablesSetToNull = $this->getOpenApiNullablesSetToNull();
			if (isset($nullablesSetToNull['benefit_plan_id'])) {
				unset($nullablesSetToNull['benefit_plan_id']);
				$this->setOpenApiNullablesSetToNull($nullablesSetToNull);
			}
		}
