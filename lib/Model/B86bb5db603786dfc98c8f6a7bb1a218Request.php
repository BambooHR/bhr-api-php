...
/**
 * B86bb5db603786dfc98c8f6a7bb1a218Request Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class B86bb5db603786dfc98c8f6a7bb1a218Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'b86bb5db603786dfc98c8f6a7bb1a218_request';
    ...
    */
    ...
    public function setStart($start)
    {
        ...
        if ((!preg_match("/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/", ObjectSerializer::toString($start)))) {
            throw new \InvalidArgumentException("invalid value for \$start when calling B86bb5db603786dfc98c8f6a7bb1a218Request., must conform to the pattern /^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.");
        }
