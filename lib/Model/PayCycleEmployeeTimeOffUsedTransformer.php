...
/**
 * PayCycleEmployeeTimeOffUsedTransformer Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class PayCycleEmployeeTimeOffUsedTransformer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayCycleEmployeeTimeOffUsedTransformer';
    ...
    */
     ...
     * Sets hour_type_id
     *
     * @param int|null $hour_type_id transform
     *
     * @return self
     */
