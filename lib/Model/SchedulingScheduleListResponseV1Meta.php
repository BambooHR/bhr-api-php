...
/**
 * SchedulingScheduleListResponseV1Meta Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SchedulingScheduleListResponseV1Meta implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Scheduling_ScheduleListResponse_V1_meta';
	...
	*/
	 ...
	 * Sets total_items
	 *
	 * @param int|null $total_items Total number of schedules matching the filter.
	 *
	 * @return self
	 */
