...
/**
 * FieldOptionsTransformerId Class Doc Comment
 *
 * @category Class
 ...
 */
class FieldOptionsTransformerId implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'FieldOptionsTransformer_id';
