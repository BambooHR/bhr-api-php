...
/**
 * CompensationBenchmarkDetailEmployeeJobTitle Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompensationBenchmarkDetailEmployeeJobTitle implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'CompensationBenchmarkDetailEmployee_jobTitle';
