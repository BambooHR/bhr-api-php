...
/**
 * EligibleUnassignedPlan Class Doc Comment
 *
 * @category Class
 * @package  MySdk
 * @author   OpenAPI Generator team
 ...
 */
class EligibleUnassignedPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EligibleUnassignedPlan';
    ...
    */
     ...
     * Sets plan_name
     *
     * @param string|null $plan_name The name of the plan.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The end date of the plan.
     *
     * @return self
     */
