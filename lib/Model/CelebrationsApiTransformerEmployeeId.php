<?php
/**
 * CelebrationsApiTransformerEmployeeId
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CelebrationsApiTransformerEmployeeId Class Doc Comment
 *
 * @category Class
 ...
 */
class CelebrationsApiTransformerEmployeeId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CelebrationsApiTransformer_employeeId';
    ...
    */
     ...
     * Sets anniversary
     *
     * @param string|null $anniversary Anniversary date of the employee
     *
     * @return self
     */
     ...
     * Sets birthday
     *
     * @param string|null $birthday Birthday of the employee in m-d format
     *
     * @return self
     */
