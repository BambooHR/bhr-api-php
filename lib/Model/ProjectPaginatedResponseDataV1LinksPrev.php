...
/**
 * ProjectPaginatedResponseDataV1LinksPrev Class Doc Comment
 *
 * @category Class
 * @description Link object for the previous page. Omitted on the first page.
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectPaginatedResponseDataV1LinksPrev implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'Project_PaginatedResponseData_V1__links_prev';
