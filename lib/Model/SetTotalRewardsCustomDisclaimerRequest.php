...
/**
 * SetTotalRewardsCustomDisclaimerRequest Class Doc Comment
 *
 * @category Class
 * @package  BhrSdk
 * @author   OpenAPI Generator team
 ...
 */
class SetTotalRewardsCustomDisclaimerRequest implements ModelInterface, ArrayAccess, \JsonSerializable {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $openApiModelName = 'set_total_rewards_custom_disclaimer_request';
	...
	*/
	...
	public function listInvalidProperties() {
		...
		if ($this->container['custom_disclaimer'] === null) {
			$invalidProperties[] = "'custom_disclaimer' can't be null";
		}
	 ...
	 *
	 * @param string $custom_disclaimer Custom disclaimer text.
	 *
	 * @return self
	 */
